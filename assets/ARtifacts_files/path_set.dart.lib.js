define(['dart_sdk', 'packages/path/src/utils.dart', 'packages/path/src/path_exception.dart'], (function load__packages__path__src__path_set_dart(dart_sdk, packages__path__src__utils$46dart, packages__path__src__path_exception$46dart) {
  ...
  var LinkedHashSetOfStringN = () => (LinkedHashSetOfStringN = dart.constFn(collection.LinkedHashSet$(StringN())))();
  var StringNAndStringNTobool = () => (StringNAndStringNTobool = dart.constFn(dart.fnType(core.bool, [StringN(), StringN()])))();
  ...
  var IterableOfStringN = () => (IterableOfStringN = dart.constFn(core.Iterable$(StringN())))();
  var SetOfStringN = () => (SetOfStringN = dart.constFn(core.Set$(StringN())))();
  ...
  var StringNTobool = () => (StringNTobool = dart.constFn(dart.fnType(core.bool, [StringN()])))();
  ...
  var L4 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/style/windows.dart";
  var L6 = "package:path/src/style.dart";
  var L9 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/style/url.dart";
  var L12 = "package:path/src/parsed_path.dart";
  var L16 = "package:path/src/context.dart";
  var L14 = "package:path/src/style/posix.dart";
  var L15 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/context.dart";
  var L13 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/style/posix.dart";
  var L5 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/internal_style.dart";
  var L17 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/path.dart";
  var L10 = "package:path/src/style/url.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/path_set.dart";
  var L2 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/path_map.dart";
  var L8 = "package:path/src/style/windows.dart";
  var L7 = "package:path/src/internal_style.dart";
  var L1 = "package:path/src/path_set.dart";
  var L11 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/path-1.8.0-nullsafety.3/lib/src/parsed_path.dart";
  var L3 = "package:path/src/path_map.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  path_set.PathSet = class PathSet extends collection.IterableBase$(dart.nullable(core.String)) {
    static _create(context) {
      ...
      return LinkedHashSetOfStringN().new({equals: dart.fn((path1, path2) => {
          if (path1 == null) return path2 == null;
          if (path2 == null) return false;
          return dart.nullCheck(context).equals(path1, path2);
        }, StringNAndStringNTobool()), hashCode: dart.fn(path => path == null ? 0 : dart.nullCheck(context).hash(path), StringNToint()), isValidKey: dart.fn(path => typeof path == 'string' || path == null, dynamicTobool())});
    }
    get iterator() {
    ...
    addAll(elements) {
      IterableOfStringN().as(elements);
      if (elements == null) dart.nullFailed(L0, 56, 33, "elements");
    ...
    containsAll(other) {
      if (other == null) dart.nullFailed(L0, 68, 38, "other");
      return this[_inner].containsAll(other);
    }
    difference(other) {
      if (other == null) dart.nullFailed(L0, 71, 40, "other");
      return this[_inner].difference(other);
    }
    intersection(other) {
      if (other == null) dart.nullFailed(L0, 74, 42, "other");
    ...
    removeAll(elements) {
      if (elements == null) dart.nullFailed(L0, 83, 36, "elements");
      return this[_inner].removeAll(elements);
    }
    removeWhere(test) {
      if (test == null) dart.nullFailed(L0, 86, 43, "test");
      return this[_inner].removeWhere(test);
    }
    retainAll(elements) {
      if (elements == null) dart.nullFailed(L0, 89, 36, "elements");
      return this[_inner].retainAll(elements);
    }
    retainWhere(test) {
      if (test == null) dart.nullFailed(L0, 92, 43, "test");
      return this[_inner].retainWhere(test);
    }
    union(other) {
      SetOfStringN().as(other);
      if (other == null) dart.nullFailed(L0, 95, 35, "other");
  ...
  (path_set.PathSet.of = function(other, opts) {
    let t0;
    if (other == null) dart.nullFailed(L0, 26, 31, "other");
    let context = opts && 'context' in opts ? opts.context : null;
  ...
  dart.setLibraryUri(path_set.PathSet, L1);
  ...
  path_map.PathMap$ = dart.generic(V => {
    class PathMap extends collection.MapView$(dart.nullable(core.String), V) {
      static _create(V, context) {
        context == null ? context = path$.context : null;
        return collection.LinkedHashMap$(StringN(), V).new({equals: dart.fn((path1, path2) => {
            if (path1 == null) return path2 == null;
            if (path2 == null) return false;
            return dart.nullCheck(context).equals(path1, path2);
          }, StringNAndStringNTobool()), hashCode: dart.fn(path => path == null ? 0 : dart.nullCheck(context).hash(path), StringNToint()), isValidKey: dart.fn(path => typeof path == 'string' || path == null, dynamicTobool())});
    ...
    (PathMap.of = function(other, opts) {
      let t0;
      if (other == null) dart.nullFailed(L2, 23, 29, "other");
      let context = opts && 'context' in opts ? opts.context : null;
  ...
  dart.setLibraryUri(style$.Style, L6);
  ...
  internal_style.InternalStyle = class InternalStyle extends style$.Style {
    getRoot(path) {
      if (path == null) dart.nullFailed(L5, 46, 26, "path");
    ...
    relativePathToUri(path) {
      if (path == null) dart.nullFailed(L5, 63, 32, "path");
    ...
    codeUnitsEqual(codeUnit1, codeUnit2) {
      if (codeUnit1 == null) dart.nullFailed(L5, 78, 27, "codeUnit1");
      if (codeUnit2 == null) dart.nullFailed(L5, 78, 42, "codeUnit2");
      return codeUnit1 == codeUnit2;
    }
    pathsEqual(path1, path2) {
      if (path1 == null) dart.nullFailed(L5, 84, 26, "path1");
      if (path2 == null) dart.nullFailed(L5, 84, 40, "path2");
      return path1 == path2;
    }
    canonicalizeCodeUnit(codeUnit) {
      if (codeUnit == null) dart.nullFailed(L5, 86, 32, "codeUnit");
      return codeUnit;
    }
    canonicalizePart(part) {
      if (part == null) dart.nullFailed(L5, 88, 34, "part");
      return part;
    }
  };
  ...
  dart.setLibraryUri(internal_style.InternalStyle, L7);
  ...
  windows.WindowsStyle = class WindowsStyle extends internal_style.InternalStyle {
    ...
    containsSeparator(path) {
      if (path == null) dart.nullFailed(L4, 36, 33, "path");
      return path[$contains]("/");
    }
    isSeparator(codeUnit) {
      if (codeUnit == null) dart.nullFailed(L4, 39, 24, "codeUnit");
      return codeUnit === 47 || codeUnit === 92;
    }
    needsSeparator(path) {
      if (path == null) dart.nullFailed(L4, 43, 30, "path");
      if (path[$isEmpty]) return false;
      return !dart.test(this.isSeparator(path[$codeUnitAt](path.length - 1)));
    }
    rootLength(path, opts) {
      if (path == null) dart.nullFailed(L4, 49, 25, "path");
      let withDrive = opts && 'withDrive' in opts ? opts.withDrive : false;
      if (withDrive == null) dart.nullFailed(L4, 49, 37, "withDrive");
    ...
    isRootRelative(path) {
      if (path == null) dart.nullFailed(L4, 76, 30, "path");
      return this.rootLength(path) === 1;
    }
    getRelativeRoot(path) {
      if (path == null) dart.nullFailed(L4, 79, 34, "path");
      let length = this.rootLength(path);
      if (length === 1) return path[$_get](0);
      return null;
    }
    pathFromUri(uri) {
      if (uri == null) dart.nullFailed(L4, 86, 26, "uri");
    ...
    absolutePathToUri(path) {
      if (path == null) dart.nullFailed(L4, 107, 32, "path");
      ...
      if (dart.nullCheck(parsed.root)[$startsWith]("\\\\")) {
        let rootParts = dart.nullCheck(parsed.root)[$split]("\\")[$where](dart.fn(part => {
          if (part == null) dart.nullFailed(L4, 114, 57, "part");
          return part !== "";
        }, StringTobool()));
    ...
    codeUnitsEqual(codeUnit1, codeUnit2) {
      if (codeUnit1 == null) dart.nullFailed(L4, 146, 27, "codeUnit1");
      if (codeUnit2 == null) dart.nullFailed(L4, 146, 42, "codeUnit2");
    ...
    pathsEqual(path1, path2) {
      if (path1 == null) dart.nullFailed(L4, 163, 26, "path1");
      if (path2 == null) dart.nullFailed(L4, 163, 40, "path2");
    ...
    canonicalizeCodeUnit(codeUnit) {
      if (codeUnit == null) dart.nullFailed(L4, 175, 32, "codeUnit");
    ...
    canonicalizePart(part) {
      if (part == null) dart.nullFailed(L4, 183, 34, "part");
  ...
  dart.setLibraryUri(windows.WindowsStyle, L8);
  ...
  url.UrlStyle = class UrlStyle extends internal_style.InternalStyle {
    ...
    containsSeparator(path) {
      if (path == null) dart.nullFailed(L9, 31, 33, "path");
      return path[$contains]("/");
    }
    isSeparator(codeUnit) {
      if (codeUnit == null) dart.nullFailed(L9, 34, 24, "codeUnit");
      return codeUnit === 47;
    }
    needsSeparator(path) {
      if (path == null) dart.nullFailed(L9, 37, 30, "path");
      if (path[$isEmpty]) return false;
    ...
    rootLength(path, opts) {
      if (path == null) dart.nullFailed(L9, 49, 25, "path");
      let withDrive = opts && 'withDrive' in opts ? opts.withDrive : false;
      if (withDrive == null) dart.nullFailed(L9, 49, 37, "withDrive");
      if (path[$isEmpty]) return 0;
    ...
    isRootRelative(path) {
      if (path == null) dart.nullFailed(L9, 78, 30, "path");
      return path[$isNotEmpty] && dart.test(this.isSeparator(path[$codeUnitAt](0)));
    }
    getRelativeRoot(path) {
      if (path == null) dart.nullFailed(L9, 82, 34, "path");
      return dart.test(this.isRootRelative(path)) ? "/" : null;
    }
    pathFromUri(uri) {
      if (uri == null) dart.nullFailed(L9, 85, 26, "uri");
      return dart.toString(uri);
    }
    relativePathToUri(path) {
      if (path == null) dart.nullFailed(L9, 88, 32, "path");
      return core.Uri.parse(path);
    }
    absolutePathToUri(path) {
      if (path == null) dart.nullFailed(L9, 90, 32, "path");
      return core.Uri.parse(path);
    }
  };
  ...
  parsed_path.ParsedPath = class ParsedPath extends core.Object {
    ...
    extension(level = 1) {
      if (level == null) dart.nullFailed(L11, 36, 25, "level");
    ...
    static parse(path, style) {
      if (path == null) dart.nullFailed(L11, 41, 35, "path");
      if (style == null) dart.nullFailed(L11, 41, 55, "style");
    ...
    normalize(opts) {
      ...
      if (canonicalize == null) dart.nullFailed(L11, 100, 24, "canonicalize");
      ...
      this.parts = newParts;
      this.separators = ListOfString().filled(dart.notNull(newParts[$length]) + 1, this.style.separator, {growable: true});
    ...
    [_kthLastIndexOf](path, character, k) {
      if (path == null) dart.nullFailed(L11, 163, 30, "path");
      if (character == null) dart.nullFailed(L11, 163, 43, "character");
      if (k == null) dart.nullFailed(L11, 163, 58, "k");
      let count = 0;
    ...
    [_splitExtension](level = 1) {
      if (level == null) dart.nullFailed(L11, 187, 37, "level");
      if (dart.notNull(level) <= 0) {
        dart.throw(new core.RangeError.value(level, "level", "level's value must be greater than 0"));
      }
      let file = this.parts[$cast](StringN())[$lastWhere](dart.fn(p => p !== "", StringNTobool()), {orElse: dart.fn(() => null, VoidToNull())});
  ...
  (parsed_path.ParsedPath.__ = function(style, root, isRootRelative, parts, separators) {
    if (style == null) dart.nullFailed(L11, 78, 12, "style");
    if (isRootRelative == null) dart.nullFailed(L11, 78, 35, "isRootRelative");
    if (parts == null) dart.nullFailed(L11, 78, 56, "parts");
    if (separators == null) dart.nullFailed(L11, 78, 68, "separators");
    this[style$0] = style;
    this[root$] = root;
  ...
  dart.setLibraryUri(parsed_path.ParsedPath, L12);
  ...
  posix.PosixStyle = class PosixStyle extends internal_style.InternalStyle {
    ...
    containsSeparator(path) {
      if (path == null) dart.nullFailed(L13, 31, 33, "path");
      return path[$contains]("/");
    }
    isSeparator(codeUnit) {
      if (codeUnit == null) dart.nullFailed(L13, 34, 24, "codeUnit");
      return codeUnit === 47;
    }
    needsSeparator(path) {
      if (path == null) dart.nullFailed(L13, 37, 30, "path");
      return path[$isNotEmpty] && !dart.test(this.isSeparator(path[$codeUnitAt](path.length - 1)));
    }
    rootLength(path, opts) {
      if (path == null) dart.nullFailed(L13, 41, 25, "path");
      let withDrive = opts && 'withDrive' in opts ? opts.withDrive : false;
      if (withDrive == null) dart.nullFailed(L13, 41, 37, "withDrive");
      if (path[$isNotEmpty] && dart.test(this.isSeparator(path[$codeUnitAt](0)))) return 1;
      return 0;
    }
    isRootRelative(path) {
      if (path == null) dart.nullFailed(L13, 47, 30, "path");
      return false;
    }
    getRelativeRoot(path) {
      if (path == null) dart.nullFailed(L13, 50, 34, "path");
      return null;
    }
    pathFromUri(uri) {
      if (uri == null) dart.nullFailed(L13, 53, 26, "uri");
      if (uri.scheme === "" || uri.scheme === "file") {
    ...
    absolutePathToUri(path) {
      if (path == null) dart.nullFailed(L13, 61, 32, "path");
      let parsed = parsed_path.ParsedPath.parse(path, this);
  ...
  dart.setLibraryUri(posix.PosixStyle, L14);
  ...
  context.Context = class Context extends core.Object {
    ...
    absolute(part1, part2 = null, part3 = null, part4 = null, part5 = null, part6 = null, part7 = null) {
      if (part1 == null) dart.nullFailed(L15, 77, 26, "part1");
      context._validateArgList("absolute", JSArrayOfStringN().of([part1, part2, part3, part4, part5, part6, part7]));
    ...
    basename(path) {
      if (path == null) dart.nullFailed(L15, 105, 26, "path");
      return this[_parse](path).basename;
    }
    basenameWithoutExtension(path) {
      if (path == null) dart.nullFailed(L15, 115, 42, "path");
      return this[_parse](path).basenameWithoutExtension;
    }
    dirname(path) {
      let t0, t0$;
      if (path == null) dart.nullFailed(L15, 126, 25, "path");
    ...
    extension(path, level = 1) {
      if (path == null) dart.nullFailed(L15, 160, 27, "path");
      if (level == null) dart.nullFailed(L15, 160, 38, "level");
      return this[_parse](path).extension(level);
    }
    rootPrefix(path) {
      if (path == null) dart.nullFailed(L15, 179, 28, "path");
      return path[$substring](0, this.style.rootLength(path));
    }
    isAbsolute(path) {
      if (path == null) dart.nullFailed(L15, 193, 26, "path");
      return dart.notNull(this.style.rootLength(path)) > 0;
    }
    isRelative(path) {
      if (path == null) dart.nullFailed(L15, 199, 26, "path");
      return !dart.test(this.isAbsolute(path));
    }
    isRootRelative(path) {
      if (path == null) dart.nullFailed(L15, 209, 30, "path");
    ...
    join(part1, part2 = null, part3 = null, part4 = null, part5 = null, part6 = null, part7 = null, part8 = null) {
      if (part1 == null) dart.nullFailed(L15, 224, 22, "part1");
      let parts = JSArrayOfStringN().of([part1, part2, part3, part4, part5, part6, part7, part8]);
      context._validateArgList("join", parts);
      return this.joinAll(parts[$whereType](core.String));
    }
    joinAll(parts) {
      if (parts == null) dart.nullFailed(L15, 260, 35, "parts");
      let buffer = new core.StringBuffer.new();
      let needsSeparator = false;
      let isAbsoluteAndNotRootRelative = false;
      let iter = parts[$where](dart.fn(part => {
        if (part == null) dart.nullFailed(L15, 265, 35, "part");
        return part !== "";
      }, StringTobool()));
    ...
    split(path) {
      if (path == null) dart.nullFailed(L15, 324, 29, "path");
      let parsed = this[_parse](path);
      parsed.parts = parsed.parts[$where](dart.fn(part => {
        if (part == null) dart.nullFailed(L15, 327, 40, "part");
    ...
    canonicalize(path) {
      if (path == null) dart.nullFailed(L15, 344, 30, "path");
    ...
    normalize(path) {
      if (path == null) dart.nullFailed(L15, 361, 27, "path");
    ...
    [_needsNormalization](path) {
      if (path == null) dart.nullFailed(L15, 370, 35, "path");
      let start = 0;
    ...
    relative(path, opts) {
      let t0, t0$, t0$0;
      if (path == null) dart.nullFailed(L15, 467, 26, "path");
    ...
    isWithin(parent, child) {
      if (parent == null) dart.nullFailed(L15, 554, 24, "parent");
      if (child == null) dart.nullFailed(L15, 554, 39, "child");
      return dart.equals(this[_isWithinOrEquals](parent, child), context._PathRelation.within);
    }
    equals(path1, path2) {
      if (path1 == null) dart.nullFailed(L15, 562, 22, "path1");
      if (path2 == null) dart.nullFailed(L15, 562, 36, "path2");
      return dart.equals(this[_isWithinOrEquals](path1, path2), context._PathRelation.equal);
    }
    [_isWithinOrEquals](parent, child) {
      if (parent == null) dart.nullFailed(L15, 569, 42, "parent");
      if (child == null) dart.nullFailed(L15, 569, 57, "child");
    ...
    [_isWithinOrEqualsFast](parent, child) {
      if (parent == null) dart.nullFailed(L15, 616, 46, "parent");
      if (child == null) dart.nullFailed(L15, 616, 61, "child");
      if (parent === ".") parent = "";
    ...
    [_pathDirection](path, index) {
      if (path == null) dart.nullFailed(L15, 824, 40, "path");
      if (index == null) dart.nullFailed(L15, 824, 50, "index");
      let depth = 0;
    ...
    hash(path) {
      if (path == null) dart.nullFailed(L15, 880, 19, "path");
      path = this.absolute(path);
    ...
    [_hashFast](path) {
      if (path == null) dart.nullFailed(L15, 897, 25, "path");
      let hash = 4603;
      let beginning = true;
    ...
    withoutExtension(path) {
      if (path == null) dart.nullFailed(L15, 953, 34, "path");
      let parsed = this[_parse](path);
    ...
    setExtension(path, extension) {
      if (path == null) dart.nullFailed(L15, 977, 30, "path");
      if (extension == null) dart.nullFailed(L15, 977, 43, "extension");
    ...
    toUri(path) {
      if (path == null) dart.nullFailed(L15, 1018, 20, "path");
    ...
    [_parse](path) {
      if (path == null) dart.nullFailed(L15, 1070, 28, "path");
  ...
  (context.Context.__ = function(style, _current) {
    if (style == null) dart.nullFailed(L15, 52, 18, "style");
    this[style$1] = style;
  ...
  dart.setLibraryUri(context.Context, L16);
  ...
  (context._PathDirection.new = function(name) {
    if (name == null) dart.nullFailed(L15, 1128, 29, "name");
    this[name$1] = name;
    ;
  ...
  dart.setLibraryUri(context._PathDirection, L16);
  ...
  context._validateArgList = function _validateArgList(method, args) {
    if (method == null) dart.nullFailed(L15, 1084, 30, "method");
    if (args == null) dart.nullFailed(L15, 1084, 52, "args");
    for (let i = 1; i < dart.notNull(args[$length]); i = i + 1) {
      ...
      message.write(args[$take](numArgs)[$map](core.String, dart.fn(arg => arg == null ? "null" : "\"" + dart.str(arg) + "\"", StringNToString()))[$join](", "));
  ...
  path$.toUri = function toUri(path) {
    if (path == null) dart.nullFailed(L17, 439, 18, "path");
  ...
  dart.copyProperties(path$, {
    ...
    get current() {
      ...
      if (dart.equals(style$.Style.platform, style$.Style.url)) {
        ...
        if (!(path[$_get](lastIndex) === "/" || path[$_get](lastIndex) === "\\")) dart.assertFailed(null, L17, 91, 12, "path[lastIndex] == '/' || path[lastIndex] == '\\\\'");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["path_set.dart","path_map.dart","style.dart","internal_style.dart","style/windows.dart","style/url.dart","parsed_path.dart","style/posix.dart","context.dart","../path.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;