define(['dart_sdk', 'packages/characters/src/grapheme_clusters/table.dart'], (function load__packages__characters__src__grapheme_clusters__breaks_dart(dart_sdk, packages__characters__src__grapheme_clusters__table$46dart) {
  ...
  var L1 = "package:characters/src/grapheme_clusters/breaks.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/characters-1.1.0-nullsafety.5/lib/src/grapheme_clusters/breaks.dart";
  ...
  (breaks.Breaks.new = function(base, cursor, end, state) {
    if (base == null) dart.nullFailed(L0, 37, 15, "base");
    if (cursor == null) dart.nullFailed(L0, 37, 26, "cursor");
    if (end == null) dart.nullFailed(L0, 37, 39, "end");
    if (state == null) dart.nullFailed(L0, 37, 49, "state");
    this[base$] = base;
    this[cursor$] = cursor;
    this[end$] = end;
    this[state$] = state;
  ...
  dart.setLibraryUri(breaks.Breaks, L1);
  ...
  breaks.BackBreaks = class BackBreaks extends core.Object {
    ...
    [_lookAhead](state) {
      if (state == null) dart.nullFailed(L0, 146, 22, "state");
      return breaks.lookAhead(this.base, this.start, this.cursor, state);
    }
  };
  (breaks.BackBreaks.new = function(base, cursor, start, state) {
    if (base == null) dart.nullFailed(L0, 105, 19, "base");
    if (cursor == null) dart.nullFailed(L0, 105, 30, "cursor");
    if (start == null) dart.nullFailed(L0, 105, 43, "start");
    if (state == null) dart.nullFailed(L0, 105, 55, "state");
    this[base$0] = base;
  ...
  dart.setLibraryUri(breaks.BackBreaks, L1);
  ...
  breaks.lookAhead = function lookAhead(base, start, cursor, state) {
    if (base == null) dart.nullFailed(L0, 155, 22, "base");
    if (start == null) dart.nullFailed(L0, 155, 32, "start");
    if (cursor == null) dart.nullFailed(L0, 155, 43, "cursor");
    if (state == null) dart.nullFailed(L0, 155, 55, "state");
    if (!(dart.notNull(state) >= 208)) dart.assertFailed(null, L0, 156, 10, "state >= stateLookaheadMin");
    if (state === 208) {
  ...
  breaks.lookAheadRegional = function lookAheadRegional(base, start, cursor) {
    if (base == null) dart.nullFailed(L0, 178, 30, "base");
    if (start == null) dart.nullFailed(L0, 178, 40, "start");
    if (cursor == null) dart.nullFailed(L0, 178, 51, "cursor");
    let count = 0;
    let index = cursor;
  ...
  breaks.lookAheadPictorgraphicExtend = function lookAheadPictorgraphicExtend(base, start, cursor) {
    if (base == null) dart.nullFailed(L0, 208, 41, "base");
    if (start == null) dart.nullFailed(L0, 208, 51, "start");
    if (cursor == null) dart.nullFailed(L0, 208, 62, "cursor");
    let index = cursor;
  ...
  breaks.isGraphemeClusterBoundary = function isGraphemeClusterBoundary(text, start, end, index) {
    if (text == null) dart.nullFailed(L0, 236, 39, "text");
    if (start == null) dart.nullFailed(L0, 236, 49, "start");
    if (end == null) dart.nullFailed(L0, 236, 60, "end");
    if (index == null) dart.nullFailed(L0, 236, 69, "index");
    if (!(0 <= dart.notNull(start))) dart.assertFailed(null, L0, 237, 10, "0 <= start");
    if (!(dart.notNull(start) <= dart.notNull(index))) dart.assertFailed(null, L0, 238, 10, "start <= index");
    if (!(dart.notNull(index) <= dart.notNull(end))) dart.assertFailed(null, L0, 239, 10, "index <= end");
    if (!(dart.notNull(end) <= text.length)) dart.assertFailed(null, L0, 240, 10, "end <= text.length");
    if (dart.notNull(start) < dart.notNull(index) && dart.notNull(index) < dart.notNull(end)) {
      ...
      if (!(dart.notNull(state) < 208)) dart.assertFailed(null, L0, 287, 12, "state < stateLookaheadMin");
  ...
  breaks.previousBreak = function previousBreak(text, start, end, index) {
    if (text == null) dart.nullFailed(L0, 300, 26, "text");
    if (start == null) dart.nullFailed(L0, 300, 36, "start");
    if (end == null) dart.nullFailed(L0, 300, 47, "end");
    if (index == null) dart.nullFailed(L0, 300, 56, "index");
    if (!(0 <= dart.notNull(start))) dart.assertFailed(null, L0, 301, 10, "0 <= start");
    if (!(dart.notNull(start) <= dart.notNull(index))) dart.assertFailed(null, L0, 302, 10, "start <= index");
    if (!(dart.notNull(index) <= dart.notNull(end))) dart.assertFailed(null, L0, 303, 10, "index <= end");
    if (!(dart.notNull(end) <= text.length)) dart.assertFailed(null, L0, 304, 10, "end <= text.length");
  ...
  breaks.nextBreak = function nextBreak(text, start, end, index) {
    if (text == null) dart.nullFailed(L0, 334, 22, "text");
    if (start == null) dart.nullFailed(L0, 334, 32, "start");
    if (end == null) dart.nullFailed(L0, 334, 43, "end");
    if (index == null) dart.nullFailed(L0, 334, 52, "index");
    if (!(0 <= dart.notNull(start))) dart.assertFailed(null, L0, 335, 10, "0 <= start");
    if (!(dart.notNull(start) <= dart.notNull(index))) dart.assertFailed(null, L0, 336, 10, "start <= index");
    if (!(dart.notNull(index) <= dart.notNull(end))) dart.assertFailed(null, L0, 337, 10, "index <= end");
    if (!(dart.notNull(end) <= text.length)) dart.assertFailed(null, L0, 338, 10, "end <= text.length");
    if (index == start || index == end) return index;
