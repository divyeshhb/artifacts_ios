define(['dart_sdk', 'packages/collection/src/comparators.dart'], (function load__packages__collection__src__equality_dart(dart_sdk, packages__collection__src__comparators$46dart) {
  ...
  var LinkedMapOf_MapEntry$int = () => (LinkedMapOf_MapEntry$int = dart.constFn(_js_helper.LinkedMap$(equality._MapEntry, core.int)))();
  const CT = Object.create(null);
  var L0 = "package:collection/src/equality.dart";
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/collection-1.15.0-nullsafety.5/lib/src/equality.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  equality.Equality$ = dart.generic(E => {
    ...
    dart.setLibraryUri(Equality, L0);
    return Equality;
  });
  ...
  equality.EqualityBy$ = dart.generic((E, F) => {
    ...
    (EqualityBy.new = function(comparisonKey, inner = C0 || CT.C0) {
      if (comparisonKey == null) dart.nullFailed(L1, 54, 28, "comparisonKey");
      if (inner == null) dart.nullFailed(L1, 55, 20, "inner");
    ...
    dart.setLibraryUri(EqualityBy, L0);
  ...
  equality.DefaultEquality$ = dart.generic(E => {
    ...
    dart.setLibraryUri(DefaultEquality, L0);
  ...
  equality.IdentityEquality$ = dart.generic(E => {
    ...
    dart.setLibraryUri(IdentityEquality, L0);
  ...
  equality.IterableEquality$ = dart.generic(E => {
    ...
    (IterableEquality.new = function(elementEquality = C0 || CT.C0) {
      if (elementEquality == null) dart.nullFailed(L1, 115, 20, "elementEquality");
    ...
    dart.setLibraryUri(IterableEquality, L0);
  ...
  equality.ListEquality$ = dart.generic(E => {
    ...
    (ListEquality.new = function(elementEquality = C0 || CT.C0) {
      if (elementEquality == null) dart.nullFailed(L1, 167, 20, "elementEquality");
    ...
    dart.setLibraryUri(ListEquality, L0);
  ...
  equality._UnorderedEquality$ = dart.generic((E, T) => {
    ...
    (_UnorderedEquality.new = function(_elementEquality) {
      if (_elementEquality == null) dart.nullFailed(L1, 209, 33, "_elementEquality");
    ...
    dart.setLibraryUri(_UnorderedEquality, L0);
  ...
  equality.UnorderedIterableEquality$ = dart.generic(E => {
    ...
    (UnorderedIterableEquality.new = function(elementEquality = C0 || CT.C0) {
      if (elementEquality == null) dart.nullFailed(L1, 256, 20, "elementEquality");
    ...
    dart.setLibraryUri(UnorderedIterableEquality, L0);
  ...
  equality.SetEquality$ = dart.generic(E => {
    ...
    (SetEquality.new = function(elementEquality = C0 || CT.C0) {
      if (elementEquality == null) dart.nullFailed(L1, 277, 20, "elementEquality");
    ...
    dart.setLibraryUri(SetEquality, L0);
    return SetEquality;
  });
  ...
  (equality._MapEntry.new = function(equality, key, value) {
    if (equality == null) dart.nullFailed(L1, 292, 18, "equality");
  ...
  dart.setLibraryUri(equality._MapEntry, L0);
  ...
  equality.MapEquality$ = dart.generic((K, V) => {
    ...
    (MapEquality.new = function(opts) {
      ...
      if (keys == null) dart.nullFailed(L1, 319, 20, "keys");
      let values = opts && 'values' in opts ? opts.values : C0 || CT.C0;
      if (values == null) dart.nullFailed(L1, 320, 19, "values");
    ...
    dart.setLibraryUri(MapEquality, L0);
  ...
  equality.MultiEquality$ = dart.generic(E => {
    ...
    (MultiEquality.new = function(equalities) {
      if (equalities == null) dart.nullFailed(L1, 381, 45, "equalities");
    ...
    dart.setLibraryUri(MultiEquality, L0);
  ...
  (equality.DeepCollectionEquality.new = function(base = C0 || CT.C0) {
    if (base == null) dart.nullFailed(L1, 427, 42, "base");
    this[_base$] = base;
    this[_unordered$] = false;
    ;
  }).prototype = equality.DeepCollectionEquality.prototype;
  (equality.DeepCollectionEquality.unordered = function(base = C0 || CT.C0) {
    if (base == null) dart.nullFailed(L1, 435, 17, "base");
    this[_base$] = base;
  ...
  dart.setLibraryUri(equality.DeepCollectionEquality, L0);
  ...
  equality.CaseInsensitiveEquality = class CaseInsensitiveEquality extends core.Object {
    equals(string1, string2) {
      ...
      if (string1 == null) dart.nullFailed(L1, 486, 22, "string1");
      core.String.as(string2);
      if (string2 == null) dart.nullFailed(L1, 486, 38, "string2");
      return comparators.equalsIgnoreAsciiCase(string1, string2);
    }
    hash(string) {
      core.String.as(string);
      if (string == null) dart.nullFailed(L1, 490, 19, "string");
  ...
  dart.setLibraryUri(equality.CaseInsensitiveEquality, L0);
