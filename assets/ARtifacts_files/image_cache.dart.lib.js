define(['dart_sdk', 'packages/flutter/src/painting/image_stream.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/scheduler/binding.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__painting__image_cache_dart(dart_sdk, packages__flutter__src__painting__image_stream$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__scheduler__binding$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/painting/image_cache.dart";
  ...
  image_cache.ImageCache = class ImageCache extends core.Object {
    ...
    set maximumSize(value) {
      let t0;
      if (value == null) dart.nullFailed(L0, 100, 23, "value");
      if (!(value != null)) dart.assertFailed(null, L0, 101, 12, "value != null");
      if (!(dart.notNull(value) >= 0)) dart.assertFailed(null, L0, 102, 12, "value >= 0");
    ...
    set maximumSizeBytes(value) {
      let t0;
      if (value == null) dart.nullFailed(L0, 139, 28, "value");
      if (!(value != null)) dart.assertFailed(null, L0, 140, 12, "value != null");
      if (!(dart.notNull(value) >= 0)) dart.assertFailed(null, L0, 141, 12, "value >= 0");
    ...
    evict(key, opts) {
      let t0;
      if (key == null) dart.nullFailed(L0, 233, 21, "key");
      let includeLive = opts && 'includeLive' in opts ? opts.includeLive : true;
      if (includeLive == null) dart.nullFailed(L0, 233, 33, "includeLive");
      if (!(includeLive != null)) dart.assertFailed(null, L0, 234, 12, "includeLive != null");
    ...
    [_touch](key, image, timelineTask) {
      if (key == null) dart.nullFailed(L0, 279, 22, "key");
      if (image == null) dart.nullFailed(L0, 279, 40, "image");
      if (!(timelineTask != null)) dart.assertFailed(null, L0, 280, 12, "timelineTask != null");
    ...
    [_trackLiveImage](key, completer, sizeBytes) {
      let t0;
      if (key == null) dart.nullFailed(L0, 290, 31, "key");
      if (completer == null) dart.nullFailed(L0, 290, 57, "completer");
      t0 = this[_liveImages][$putIfAbsent](key, dart.fn(() => new image_cache._LiveImage.new(completer, dart.fn(() => {
        this[_liveImages][$remove](key);
      }, VoidTovoid())), VoidTo_LiveImage()));
      t0.sizeBytes == null ? t0.sizeBytes = sizeBytes : null;
    }
    putIfAbsent(key, loader, opts) {
      let t0, t0$, t1;
      if (key == null) dart.nullFailed(L0, 317, 44, "key");
      if (loader == null) dart.nullFailed(L0, 317, 70, "loader");
      let onError = opts && 'onError' in opts ? opts.onError : null;
      if (!(key != null)) dart.assertFailed(null, L0, 318, 12, "key != null");
      if (!(loader != null)) dart.assertFailed(null, L0, 319, 12, "loader != null");
      let timelineTask = null;
      ...
      const listener = (info, syncCall) => {
        let t1;
        if (syncCall == null) dart.nullFailed(L0, 406, 41, "syncCall");
        let sizeBytes = null;
        if (info != null) {
        ...
        if (!false && !listenedOnce) {
          dart.nullCheck(listenerTask).finish({arguments: new (IdentityMapOfString$dynamic()).from(["syncCall", syncCall, "sizeInBytes", sizeBytes])});
    ...
    statusForKey(key) {
      if (key == null) dart.nullFailed(L0, 456, 40, "key");
    ...
    containsKey(key) {
      if (key == null) dart.nullFailed(L0, 465, 27, "key");
    ...
    [_checkCacheSize](timelineTask) {
      ...
      if (!(dart.notNull(this[_currentSizeBytes]) >= 0)) dart.assertFailed(null, L0, 523, 12, "_currentSizeBytes >= 0");
      if (!(dart.notNull(this[_cache][$length]) <= dart.notNull(this.maximumSize))) dart.assertFailed(null, L0, 524, 12, "_cache.length <= maximumSize");
      if (!(dart.notNull(this[_currentSizeBytes]) <= dart.notNull(this.maximumSizeBytes))) dart.assertFailed(null, L0, 525, 12, "_currentSizeBytes <= maximumSizeBytes");
    }
  };
  ...
  (image_cache.ImageCacheStatus.__ = function(opts) {
    ...
    if (pending == null) dart.nullFailed(L0, 549, 10, "pending");
    let keepAlive = opts && 'keepAlive' in opts ? opts.keepAlive : false;
    if (keepAlive == null) dart.nullFailed(L0, 550, 10, "keepAlive");
    let live = opts && 'live' in opts ? opts.live : false;
    if (live == null) dart.nullFailed(L0, 551, 10, "live");
    this[pending$] = pending;
    this[keepAlive$] = keepAlive;
    this[live$] = live;
    if (!(!dart.test(pending) || !dart.test(keepAlive))) dart.assertFailed(null, L0, 552, 15, "!pending || !keepAlive");
    ;
  ...
  image_cache._CachedImageBase = class _CachedImageBase extends core.Object {
    dispose() {
      if (!(this.handle != null)) dart.assertFailed(null, L0, 617, 12, "handle != null");
      dart.nullCheck(binding.SchedulerBinding.instance).addPostFrameCallback(dart.fn(timeStamp => {
        let t1;
        if (timeStamp == null) dart.nullFailed(L0, 620, 63, "timeStamp");
        if (!(this.handle != null)) dart.assertFailed(null, L0, 621, 14, "handle != null");
        t1 = this.handle;
  ...
  (image_cache._CachedImageBase.new = function(completer, opts) {
    if (completer == null) dart.nullFailed(L0, 606, 10, "completer");
    let sizeBytes = opts && 'sizeBytes' in opts ? opts.sizeBytes : null;
    this.completer = completer;
    this.sizeBytes = sizeBytes;
    if (!(completer != null)) dart.assertFailed(null, L0, 608, 15, "completer != null");
  ...
  dart.setLibraryUri(image_cache._CachedImageBase, L1);
  ...
  (image_cache._CachedImage.new = function(completer, opts) {
    if (completer == null) dart.nullFailed(L0, 629, 37, "completer");
    let sizeBytes = opts && 'sizeBytes' in opts ? opts.sizeBytes : null;
  ...
  image_cache._LiveImage = class _LiveImage extends image_cache._CachedImageBase {
    ...
    set [_handleRemove](t1) {
      if (t1 == null) dart.nullFailed(L0, 643, 21, "null");
  ...
  (image_cache._LiveImage.new = function(completer, handleRemove, opts) {
    if (completer == null) dart.nullFailed(L0, 634, 35, "completer");
    if (handleRemove == null) dart.nullFailed(L0, 634, 59, "handleRemove");
    let sizeBytes = opts && 'sizeBytes' in opts ? opts.sizeBytes : null;
  ...
  (image_cache._PendingImage.new = function(completer, listener) {
    if (completer == null) dart.nullFailed(L0, 656, 22, "completer");
    if (listener == null) dart.nullFailed(L0, 656, 38, "listener");
    this.completer = completer;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["image_cache.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;