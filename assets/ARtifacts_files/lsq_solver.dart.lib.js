define(['dart_sdk'], (function load__packages__flutter__src__gestures__lsq_solver_dart(dart_sdk) {
  ...
  var L1 = "package:flutter/src/gestures/lsq_solver.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/gestures/lsq_solver.dart";
  ...
  lsq_solver._Vector = class _Vector extends core.Object {
    _get(i) {
      if (i == null) dart.nullFailed(L0, 29, 26, "i");
      return this[_elements][$_get](dart.notNull(i) + dart.notNull(this[_offset]));
    }
    _set(i, value$) {
      let value = value$;
      if (i == null) dart.nullFailed(L0, 30, 25, "i");
      if (value == null) dart.nullFailed(L0, 30, 35, "value");
      this[_elements][$_set](dart.notNull(i) + dart.notNull(this[_offset]), value);
      return value$;
    }
    ['*'](a) {
      if (a == null) dart.nullFailed(L0, 34, 29, "a");
      let result = 0.0;
  ...
  (lsq_solver._Vector.new = function(size) {
    if (size == null) dart.nullFailed(L0, 13, 15, "size");
    this[_offset] = 0;
    this[_length] = size;
  ...
  (lsq_solver._Vector.fromVOL = function(values, offset, length) {
    if (values == null) dart.nullFailed(L0, 18, 32, "values");
    if (offset == null) dart.nullFailed(L0, 18, 44, "offset");
    if (length == null) dart.nullFailed(L0, 18, 56, "length");
    this[_offset] = offset;
    this[_length] = length;
  ...
  dart.setLibraryUri(lsq_solver._Vector, L1);
  ...
  lsq_solver._Matrix = class _Matrix extends core.Object {
    get(row, col) {
      if (row == null) dart.nullFailed(L0, 53, 18, "row");
      if (col == null) dart.nullFailed(L0, 53, 27, "col");
      return this[_elements][$_get](dart.notNull(row) * dart.notNull(this[_columns]) + dart.notNull(col));
    }
    set(row, col, value) {
      if (row == null) dart.nullFailed(L0, 54, 16, "row");
      if (col == null) dart.nullFailed(L0, 54, 25, "col");
      if (value == null) dart.nullFailed(L0, 54, 37, "value");
      this[_elements][$_set](dart.notNull(row) * dart.notNull(this[_columns]) + dart.notNull(col), value);
    }
    getRow(row) {
      if (row == null) dart.nullFailed(L0, 58, 22, "row");
  ...
  (lsq_solver._Matrix.new = function(rows, cols) {
    if (rows == null) dart.nullFailed(L0, 46, 15, "rows");
    if (cols == null) dart.nullFailed(L0, 46, 25, "cols");
    this[_columns] = cols;
  ...
  dart.setLibraryUri(lsq_solver._Matrix, L1);
  ...
  dart.setLibraryUri(lsq_solver.PolynomialFit, L1);
  ...
  lsq_solver.LeastSquaresSolver = class LeastSquaresSolver extends core.Object {
    ...
    solve(degree) {
      let t2, t1, t2$, t1$;
      if (degree == null) dart.nullFailed(L0, 102, 28, "degree");
  ...
  (lsq_solver.LeastSquaresSolver.new = function(x, y, w) {
    if (x == null) dart.nullFailed(L0, 86, 27, "x");
    if (y == null) dart.nullFailed(L0, 86, 35, "y");
    if (w == null) dart.nullFailed(L0, 86, 43, "w");
    this[x$] = x;
    this[y$] = y;
    this[w$] = w;
    if (!(x[$length] == y[$length])) dart.assertFailed(null, L0, 87, 14, "x.length == y.length");
    if (!(y[$length] == w[$length])) dart.assertFailed(null, L0, 88, 14, "y.length == w.length");
    ;
  ...
  dart.setLibraryUri(lsq_solver.LeastSquaresSolver, L1);
