define(['dart_sdk', 'packages/flutter/src/widgets/widget_span.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__widgets__async_dart(dart_sdk, packages__flutter__src__widgets__widget_span$46dart, packages__flutter__src__foundation__object$46dart) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/widgets/async.dart";
  ...
  async$.StreamBuilderBase$ = dart.generic((T, S) => {
    ...
    class StreamBuilderBase extends framework.StatefulWidget {
      ...
      afterError(current, error, stackTrace) {
        S.as(current);
        if (error == null) dart.nullFailed(L0, 82, 34, "error");
        if (stackTrace == null) dart.nullFailed(L0, 82, 52, "stackTrace");
        return current;
      }
      afterDone(current) {
        S.as(current);
  ...
  async$._StreamBuilderBaseState$ = dart.generic((T, S) => {
    ...
    class _StreamBuilderBaseState extends framework.State$(async$.StreamBuilderBase$(T, S)) {
      ...
      didUpdateWidget(oldWidget) {
        ...
        if (oldWidget == null) dart.nullFailed(L0, 116, 48, "oldWidget");
      ...
      build(context) {
        if (context == null) dart.nullFailed(L0, 128, 29, "context");
        ...
        if (this.widget.stream != null) {
          this[_subscription] = dart.nullCheck(this.widget.stream).listen(dart.fn(data => {
            this.setState(dart.fn(() => {
              ...
              if (error == null) dart.nullFailed(L0, 142, 27, "error");
              if (stackTrace == null) dart.nullFailed(L0, 142, 45, "stackTrace");
              this.setState(dart.fn(() => {
                this[_summary] = this.widget.afterError(this[_summary], error, stackTrace);
              }, VoidTovoid()));
            }, ObjectAndStackTraceToNull()), onDone: dart.fn(() => {
              this.setState(dart.fn(() => {
  ...
  (async$.ConnectionState.new = function(index, _name) {
    if (index == null) dart.nullFailed(L0, 177, 6, "index");
    if (_name == null) dart.nullFailed(L0, 177, 6, "_name");
    this.index = index;
    this[_name$] = _name;
    ;
  ...
  async$.AsyncSnapshot$ = dart.generic(T => {
    ...
    class AsyncSnapshot extends core.Object {
      ...
      inState(state) {
        if (state == null) dart.nullFailed(L0, 280, 44, "state");
      ...
      _equals(other) {
        ...
        return AsyncSnapshotOfT().is(other) && dart.equals(other.connectionState, this.connectionState) && dart.equals(other.data, this.data) && dart.equals(other.error, this.error) && dart.equals(other.stackTrace, this.stackTrace);
      }
      get hashCode() {
    ...
    (AsyncSnapshot.__ = function(connectionState, data, error, stackTrace) {
      if (connectionState == null) dart.nullFailed(L0, 210, 30, "connectionState");
      this[connectionState$] = connectionState;
      this[data$] = data;
      this[error$] = error;
      this[stackTrace$] = stackTrace;
      if (!(connectionState != null)) dart.assertFailed(null, L0, 211, 14, "connectionState != null");
      if (!!(data != null && error != null)) dart.assertFailed(null, L0, 212, 14, "!(data != null && error != null)");
      if (!(stackTrace == null || error != null)) dart.assertFailed(null, L0, 213, 14, "stackTrace == null || error != null");
      ;
    ...
    (AsyncSnapshot.withData = function(state, data) {
      if (state == null) dart.nullFailed(L0, 222, 48, "state");
      AsyncSnapshot.__.call(this, state, data, null, null);
    }).prototype = AsyncSnapshot.prototype;
    (AsyncSnapshot.withError = function(state, error, stackTrace = C5 || CT.C5) {
      if (state == null) dart.nullFailed(L0, 229, 21, "state");
      if (error == null) dart.nullFailed(L0, 230, 12, "error");
      if (stackTrace == null) dart.nullFailed(L0, 231, 16, "stackTrace");
  ...
  async$.StreamBuilder$ = dart.generic(T => {
    ...
    class StreamBuilder extends async$.StreamBuilderBase$(T, async$.AsyncSnapshot$(T)) {
      ...
      afterConnected(current) {
        ...
        if (current == null) dart.nullFailed(L0, 530, 52, "current");
        return current.inState(async$.ConnectionState.waiting);
      }
      afterData(current, data) {
        AsyncSnapshotOfT().as(current);
        if (current == null) dart.nullFailed(L0, 533, 47, "current");
        T.as(data);
        return new (AsyncSnapshotOfT()).withData(async$.ConnectionState.active, data);
      }
      afterError(current, error, stackTrace) {
        AsyncSnapshotOfT().as(current);
        if (current == null) dart.nullFailed(L0, 538, 48, "current");
        if (error == null) dart.nullFailed(L0, 538, 64, "error");
        if (stackTrace == null) dart.nullFailed(L0, 538, 82, "stackTrace");
        return new (AsyncSnapshotOfT()).withError(async$.ConnectionState.active, error, stackTrace);
      }
      afterDone(current) {
        AsyncSnapshotOfT().as(current);
        if (current == null) dart.nullFailed(L0, 543, 47, "current");
        return current.inState(async$.ConnectionState.done);
      }
      afterDisconnected(current) {
        AsyncSnapshotOfT().as(current);
        if (current == null) dart.nullFailed(L0, 546, 55, "current");
        return current.inState(async$.ConnectionState.none);
      }
      build(context, currentSummary) {
        let t2, t1;
        if (context == null) dart.nullFailed(L0, 549, 29, "context");
        AsyncSnapshotOfT().as(currentSummary);
        if (currentSummary == null) dart.nullFailed(L0, 549, 55, "currentSummary");
        t1 = context;
        t2 = currentSummary;
    ...
    (StreamBuilder.new = function(opts) {
      ...
      if (builder == null) dart.nullFailed(L0, 504, 19, "builder");
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      this[initialData$] = initialData;
      this[builder$] = builder;
      if (!(builder != null)) dart.assertFailed(null, L0, 505, 15, "builder != null");
  ...
  async$.FutureBuilder$ = dart.generic(T => {
    ...
    (FutureBuilder.new = function(opts) {
      ...
      let initialData = opts && 'initialData' in opts ? opts.initialData : null;
      let builder = opts && 'builder' in opts ? opts.builder : null;
      if (builder == null) dart.nullFailed(L0, 698, 19, "builder");
      let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
      this[future$] = future;
      this[initialData$0] = initialData;
      this[builder$0] = builder;
      if (!(builder != null)) dart.assertFailed(null, L0, 699, 15, "builder != null");
  ...
  async$._FutureBuilderState$ = dart.generic(T => {
    ...
    class _FutureBuilderState extends framework.State$(async$.FutureBuilder$(T)) {
      ...
      set [_snapshot](t1) {
        if (t1 == null) dart.nullFailed(L0, 753, 25, "null");
      ...
      didUpdateWidget(oldWidget) {
        ...
        if (oldWidget == null) dart.nullFailed(L0, 765, 41, "oldWidget");
        super.didUpdateWidget(oldWidget);
        ...
        if (this.widget.future != null) {
          ...
          dart.nullCheck(this.widget.future).then(dart.void, dart.fn(data => {
            if (dart.equals(this[_activeCallbackIdentity], callbackIdentity)) {
              ...
              if (error == null) dart.nullFailed(L0, 795, 27, "error");
              if (stackTrace == null) dart.nullFailed(L0, 795, 45, "stackTrace");
              if (dart.equals(this[_activeCallbackIdentity], callbackIdentity)) {
                this.setState(dart.fn(() => {
  ...
  }, '{"version":3,"sourceRoot":"","sources":