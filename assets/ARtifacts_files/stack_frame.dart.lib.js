define(['dart_sdk', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__foundation__stack_frame_dart(dart_sdk, packages__flutter__src__foundation__object$46dart) {
  ...
  var StackFrameN = () => (StackFrameN = dart.constFn(dart.nullable(stack_frame.StackFrame)))();
  var StringToStackFrameN = () => (StringToStackFrameN = dart.constFn(dart.fnType(StackFrameN(), [core.String])))();
  const CT = Object.create(null);
  var L1 = "package:flutter/src/foundation/stack_frame.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/foundation/stack_frame.dart";
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(stack_frame.StackFrame.fromStackTraceLine, StringToStackFrameN());
    },
    get C1() {
  ...
  stack_frame.StackFrame = class StackFrame extends core.Object {
    ...
    static fromStackTrace(stack) {
      if (stack == null) dart.nullFailed(L0, 78, 53, "stack");
      if (!(stack != null)) dart.assertFailed(null, L0, 79, 12, "stack != null");
      return stack_frame.StackFrame.fromStackString(dart.toString(stack));
    }
    static fromStackString(stack) {
      if (stack == null) dart.nullFailed(L0, 84, 50, "stack");
      if (!(stack != null)) dart.assertFailed(null, L0, 85, 12, "stack != null");
      return stack[$trim]()[$split]("\n")[$where](dart.fn(line => {
        if (line == null) dart.nullFailed(L0, 89, 24, "line");
        return line[$isNotEmpty];
      }, StringTobool()))[$map](StackFrameN(), C0 || CT.C0)[$whereType](stack_frame.StackFrame)[$toList]();
    }
    static _parseWebFrame(line) {
      if (line == null) dart.nullFailed(L0, 98, 44, "line");
      if (true) {
    ...
    static _parseWebDebugFrame(line) {
      if (line == null) dart.nullFailed(L0, 106, 48, "line");
      ...
      if (!(match != null)) dart.assertFailed("Expected " + dart.str(line) + " to match " + dart.str(parser) + ".", L0, 114, 12, "match != null");
    ...
    static _parseWebNonDebugFrame(line) {
      if (line == null) dart.nullFailed(L0, 148, 52, "line");
    ...
    static fromStackTraceLine(line) {
      if (line == null) dart.nullFailed(L0, 185, 48, "line");
      if (!(line != null)) dart.assertFailed(null, L0, 186, 12, "line != null");
      if (line === "<asynchronous suspension>") {
        return stack_frame.StackFrame.asynchronousSuspension;
      } else if (line === "...") {
        return stack_frame.StackFrame.stackOverFlowElision;
      }
      if (!(line !== "===== asynchronous gap ===========================")) dart.assertFailed("Got a stack frame from package:stack_trace, where a vm or web frame was expected. " + "This can happen if FlutterError.demangleStackTrace was not set in an environment " + "that propagates non-standard stack traces to the framework, such as during tests.", L0, 194, 7, "line != '===== asynchronous gap ==========================='");
      if (!line[$startsWith]("#")) {
        return stack_frame.StackFrame._parseWebFrame(line);
      }
      let parser = core.RegExp.new("^#(\\d+) +(.+) \\((.+?):?(\\d+){0,1}:?(\\d+){0,1}\\)$");
      let match = parser.firstMatch(line);
      if (!(match != null)) dart.assertFailed("Expected " + dart.str(line) + " to match " + dart.str(parser) + ".", L0, 207, 12, "match != null");
      match = dart.nullCheck(match);
  ...
  (stack_frame.StackFrame.new = function(opts) {
    ...
    if (number == null) dart.nullFailed(L0, 30, 19, "number");
    let column = opts && 'column' in opts ? opts.column : null;
    if (column == null) dart.nullFailed(L0, 31, 19, "column");
    let line = opts && 'line' in opts ? opts.line : null;
    if (line == null) dart.nullFailed(L0, 32, 19, "line");
    let packageScheme = opts && 'packageScheme' in opts ? opts.packageScheme : null;
    if (packageScheme == null) dart.nullFailed(L0, 33, 19, "packageScheme");
    let $package = opts && 'package' in opts ? opts.package : null;
    if ($package == null) dart.nullFailed(L0, 34, 19, "package");
    let packagePath = opts && 'packagePath' in opts ? opts.packagePath : null;
    if (packagePath == null) dart.nullFailed(L0, 35, 19, "packagePath");
    let className = opts && 'className' in opts ? opts.className : "";
    if (className == null) dart.nullFailed(L0, 36, 10, "className");
    let method = opts && 'method' in opts ? opts.method : null;
    if (method == null) dart.nullFailed(L0, 37, 19, "method");
    let isConstructor = opts && 'isConstructor' in opts ? opts.isConstructor : false;
    if (isConstructor == null) dart.nullFailed(L0, 38, 10, "isConstructor");
    let source = opts && 'source' in opts ? opts.source : null;
    if (source == null) dart.nullFailed(L0, 39, 19, "source");
    this[number$] = number;
    this[column$] = column;
    this[line$] = line;
    ...
    this[source$] = source;
    if (!(number != null)) dart.assertFailed(null, L0, 40, 16, "number != null");
    if (!(column != null)) dart.assertFailed(null, L0, 41, 16, "column != null");
    if (!(line != null)) dart.assertFailed(null, L0, 42, 16, "line != null");
    if (!(method != null)) dart.assertFailed(null, L0, 43, 16, "method != null");
    if (!(packageScheme != null)) dart.assertFailed(null, L0, 44, 16, "packageScheme != null");
    if (!($package != null)) dart.assertFailed(null, L0, 45, 16, "package != null");
    if (!(packagePath != null)) dart.assertFailed(null, L0, 46, 16, "packagePath != null");
    if (!(className != null)) dart.assertFailed(null, L0, 47, 16, "className != null");
    if (!(isConstructor != null)) dart.assertFailed(null, L0, 48, 16, "isConstructor != null");
    if (!(source != null)) dart.assertFailed(null, L0, 49, 16, "source != null");
    ;
  ...
  dart.setLibraryUri(stack_frame.StackFrame, L1);
