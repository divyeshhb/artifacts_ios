define(['dart_sdk', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__rendering__list_body_dart(dart_sdk, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/rendering/list_body.dart";
  ...
  list_body.RenderListBody = class RenderListBody extends RenderBox_RenderBoxContainerDefaultsMixin$36 {
    setupParentData(child) {
      ...
      if (child == null) dart.nullFailed(L1, 41, 34, "child");
    ...
    set axisDirection(value) {
      if (value == null) dart.nullFailed(L1, 52, 35, "value");
      if (!(value != null)) dart.assertFailed(null, L1, 53, 12, "value != null");
    ...
    computeDryLayout(constraints) {
      if (constraints == null) dart.nullFailed(L1, 65, 40, "constraints");
      if (!dart.test(this[_debugCheckConstraints](constraints))) dart.assertFailed(null, L1, 66, 12, "_debugCheckConstraints(constraints)");
    ...
    [_debugCheckConstraints](constraints) {
      if (constraints == null) dart.nullFailed(L1, 91, 46, "constraints");
    ...
    performLayout() {
      ...
      switch (this.axisDirection) {
        case C1 || CT.C1:
        {
          ...
          while (child != null) {
            ...
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 165, 18, "child.parentData == childParentData");
        ...
        case C2 || CT.C2:
        {
          ...
          while (child != null) {
            ...
            let childParentData = list_body.ListBodyParentData.as(dart.nullCheck(child.parentData));
            mainAxisExtent = mainAxisExtent + dart.notNull(child.size.width);
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 176, 18, "child.parentData == childParentData");
            child = childParentData.nextSibling;
          }
          let position = 0.0;
          ...
          while (child != null) {
            ...
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 185, 18, "child.parentData == childParentData");
            child = childParentData.nextSibling;
          }
          this.size = constraints.constrain(new ui.Size.new(mainAxisExtent, constraints.maxHeight));
          break;
        ...
        case C0 || CT.C0:
        {
          ...
          while (child != null) {
            ...
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 197, 18, "child.parentData == childParentData");
            child = childParentData.nextSibling;
          }
        ...
        case C3 || CT.C3:
        {
          ...
          while (child != null) {
            ...
            let childParentData = list_body.ListBodyParentData.as(dart.nullCheck(child.parentData));
            mainAxisExtent = mainAxisExtent + dart.notNull(child.size.height);
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 208, 18, "child.parentData == childParentData");
            child = childParentData.nextSibling;
          }
          let position = 0.0;
          child = this.firstChild;
          while (child != null) {
            ...
            if (!dart.equals(child.parentData, childParentData)) dart.assertFailed(null, L1, 217, 18, "child.parentData == childParentData");
            child = childParentData.nextSibling;
          }
          this.size = constraints.constrain(new ui.Size.new(constraints.maxWidth, mainAxisExtent));
          break;
      ...
      if (!dart.test(this.size.isFinite)) dart.assertFailed(null, L1, 223, 12, "size.isFinite");
    }
    debugFillProperties(properties) {
      if (properties == null) dart.nullFailed(L1, 227, 56, "properties");
    ...
    [_getIntrinsicCrossAxis](childSize) {
      if (childSize == null) dart.nullFailed(L1, 232, 54, "childSize");
      let extent = 0.0;
      let child = this.firstChild;
      while (child != null) {
    ...
    [_getIntrinsicMainAxis](childSize) {
      if (childSize == null) dart.nullFailed(L1, 243, 53, "childSize");
      let extent = 0.0;
      let child = this.firstChild;
      while (child != null) {
    ...
    computeMinIntrinsicWidth(height) {
      if (height == null) dart.nullFailed(L1, 255, 42, "height");
      if (!(this.mainAxis != null)) dart.assertFailed(null, L1, 256, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C4 || CT.C4:
        {
          return this[_getIntrinsicMainAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 259, 49, "child");
        ...
        case C5 || CT.C5:
        {
          return this[_getIntrinsicCrossAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 261, 50, "child");
            return child.getMinIntrinsicWidth(height);
          }, RenderBoxTodouble()));
        }
        default:
    ...
    computeMaxIntrinsicWidth(height) {
      if (height == null) dart.nullFailed(L1, 266, 42, "height");
      if (!(this.mainAxis != null)) dart.assertFailed(null, L1, 267, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C4 || CT.C4:
        {
          return this[_getIntrinsicMainAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 270, 49, "child");
        ...
        {
          return this[_getIntrinsicCrossAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 272, 50, "child");
            return child.getMaxIntrinsicWidth(height);
          }, RenderBoxTodouble()));
        }
        default:
    ...
    computeMinIntrinsicHeight(width) {
      if (width == null) dart.nullFailed(L1, 277, 43, "width");
      if (!(this.mainAxis != null)) dart.assertFailed(null, L1, 278, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C4 || CT.C4:
        {
          return this[_getIntrinsicMainAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 281, 49, "child");
        ...
        {
          return this[_getIntrinsicCrossAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 283, 50, "child");
            return child.getMinIntrinsicHeight(width);
          }, RenderBoxTodouble()));
        }
        default:
    ...
    computeMaxIntrinsicHeight(width) {
      if (width == null) dart.nullFailed(L1, 288, 43, "width");
      if (!(this.mainAxis != null)) dart.assertFailed(null, L1, 289, 12, "mainAxis != null");
      switch (this.mainAxis) {
        case C4 || CT.C4:
        {
          return this[_getIntrinsicMainAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 292, 49, "child");
        ...
        {
          return this[_getIntrinsicCrossAxis](dart.fn(child => {
            if (child == null) dart.nullFailed(L1, 294, 50, "child");
            return child.getMaxIntrinsicHeight(width);
          }, RenderBoxTodouble()));
        }
        default:
    ...
    computeDistanceToActualBaseline(baseline) {
      if (baseline == null) dart.nullFailed(L1, 299, 56, "baseline");
      return this.defaultComputeDistanceToFirstActualBaseline(baseline);
    }
    paint(context, offset) {
      if (context == null) dart.nullFailed(L1, 304, 30, "context");
      if (offset == null) dart.nullFailed(L1, 304, 46, "offset");
      this.defaultPaint(context, offset);
    }
    hitTestChildren(result, opts) {
      if (result == null) dart.nullFailed(L1, 309, 41, "result");
      let position = opts && 'position' in opts ? opts.position : null;
      if (position == null) dart.nullFailed(L1, 309, 67, "position");
  ...
  (list_body.RenderListBody.new = function(opts) {
    ...
    if (axisDirection == null) dart.nullFailed(L1, 34, 19, "axisDirection");
    if (!(axisDirection != null)) dart.assertFailed(null, L1, 35, 15, "axisDirection != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["list_body.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EAUqE;;;;;;;;;;;;;;;;;;;;;;;;;;;;uBA8BpC;;AAC7B,WAAqB,gCAAjB,AAAM,KAAD,cACP,AAAM,AAAiC,KAAlC,cAAc;IACvB;;AAMmC;IAAc;;UAEjB;AAC9B,YAAO,AAAM,KAAD,IAAI;AAChB,UAAmB,YAAf,sBAAkB,KAAK,GACzB;AACoB,MAAtB,uBAAiB,KAAK;AACL,MAAjB;IACF;;AAIqB,6CAAoB;IAAc;;UAGlB;AACnC,qBAAO,6BAAuB,WAAW;AAClC,2BAAiB;AACb,kBAAQ;AACnB,cAAQ;;;;AAGiB,iCAAkC,yCAAiB,AAAY,WAAD;AACnF,iBAAO,KAAK,IAAI;AACH,4BAAY,AAAM,KAAD,cAAc,gBAAgB;AACzB,YAAjC,iBAAA,AAAe,cAAD,gBAAI,AAAU,SAAD;AACF,YAAzB,QAAQ,gBAAW,KAAK;;AAE1B,gBAAO,AAAY,YAAD,WAAW,gBAAK,cAAc,EAAE,AAAY,WAAD;;;;;AAGxC,iCAAkC,wCAAgB,AAAY,WAAD;AAClF,iBAAO,KAAK,IAAI;AACH,4BAAY,AAAM,KAAD,cAAc,gBAAgB;AACxB,YAAlC,iBAAA,AAAe,cAAD,gBAAI,AAAU,SAAD;AACF,YAAzB,QAAQ,gBAAW,KAAK;;AAE1B,gBAAO,AAAY,YAAD,WAAW,gBAAK,AAAY,WAAD,WAAW,cAAc;;;;AAlB1E;;;IAoBF;;UAE2C;AACzC,qBAAO,AAuBN;AAtBC,gBAAQ;;;AAEJ,2BAAK,AAAY,WAAD,mBACd,MAAO;AACT;;;;AAEA,2BAAK,AAAY,WAAD,oBACd,MAAO;AACT;;;;AARJ;;;AAqBE,QAXF,WAAmB,sCAA2B,+BAC5C,gCAAa,kEACb,oCAAgB,AACd,wEACA,yDACA,UAEF,6BAAS,AACP,0DACA;;AAIN,qBAAO,AA+BN;AA9BC,gBAAQ;;;AAEJ,0BAAI,AAAY,WAAD,oBACb,MAAO;AACT;;;;AAEA,0BAAI,AAAY,WAAD,mBACb,MAAO;AACT;;;;AARJ;;;AA6BE,QAhBF,WAAmB,sCAA2B,+BAC5C,gCAAa,sEACb,oCAAgB,AACd,yFACA,gEACA,gCAIF,6BAAS,AACP,yDACA,qEACA,iFACA,0EACA;;AAIN,YAAO;IACT;;AAIuB,wBAAmB;AACxC,qBAAO,6BAAuB,WAAW;AAClC,2BAAiB;AACb,kBAAQ;AACnB,cAAQ;;;AAEiB,iCAAkC,yCAAiB,AAAY,WAAD;AACnF,iBAAO,KAAK,IAAI;AACsC,YAApD,AAAM,KAAD,QAAQ,gBAAgB,mBAAkB;AACtB,kCAAoC,gCAAF,eAAhB,AAAM,K