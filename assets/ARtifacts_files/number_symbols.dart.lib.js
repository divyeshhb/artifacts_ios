define(['dart_sdk'], (function load__packages__intl__number_symbols_dart(dart_sdk) {
  ...
  var L0 = "package:intl/number_symbols.dart";
  ...
  dart.setMethodSignature(number_symbols.NumberSymbols, () => ({
    __proto__: dart.getMethods(number_symbols.NumberSymbols.__proto__),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), [])
  }));
  dart.setLibraryUri(number_symbols.NumberSymbols, L0);
  dart.setFieldSignature(number_symbols.NumberSymbols, () => ({
    ...
    DECIMAL_SEP: dart.finalFieldType(dart.legacy(core.String)),
    GROUP_SEP: dart.finalFieldType(dart.legacy(core.String)),
    PERCENT: dart.finalFieldType(dart.legacy(core.String)),
    ZERO_DIGIT: dart.finalFieldType(dart.legacy(core.String)),
    PLUS_SIGN: dart.finalFieldType(dart.legacy(core.String)),
    MINUS_SIGN: dart.finalFieldType(dart.legacy(core.String)),
    EXP_SYMBOL: dart.finalFieldType(dart.legacy(core.String)),
    PERMILL: dart.finalFieldType(dart.legacy(core.String)),
    INFINITY: dart.finalFieldType(dart.legacy(core.String)),
    NAN: dart.finalFieldType(dart.legacy(core.String)),
    DECIMAL_PATTERN: dart.finalFieldType(dart.legacy(core.String)),
    SCIENTIFIC_PATTERN: dart.finalFieldType(dart.legacy(core.String)),
    PERCENT_PATTERN: dart.finalFieldType(dart.legacy(core.String)),
    CURRENCY_PATTERN: dart.finalFieldType(dart.legacy(core.String)),
    DEF_CURRENCY_CODE: dart.finalFieldType(dart.legacy(core.String))
  }));
  ...
  dart.setLibraryUri(number_symbols.CompactNumberSymbols, L0);
  dart.setFieldSignature(number_symbols.CompactNumberSymbols, () => ({
    ...
    COMPACT_DECIMAL_SHORT_PATTERN: dart.finalFieldType(dart.legacy(core.Map$(dart.legacy(core.int), dart.legacy(core.String)))),
    COMPACT_DECIMAL_LONG_PATTERN: dart.finalFieldType(dart.legacy(core.Map$(dart.legacy(core.int), dart.legacy(core.String)))),
    COMPACT_DECIMAL_SHORT_CURRENCY_PATTERN: dart.finalFieldType(dart.legacy(core.Map$(dart.legacy(core.int), dart.legacy(core.String))))
  }));
  dart.trackLibraries("packages/intl/number_symbols.dart", {
    "package:intl/number_symbols.dart": number_symbols
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["number_symbols.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;IAae;;;;;;IACA;;;;;;IACT;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;IACA;;;;;;;AAoBiB;IAAI;;;QAjBf;QACD;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;QACA;IAfC;IACD;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;IACA;;EAAmB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAUL;;;;;;IACA;;;;;;IACA;;;;;;;;QAEb;QACD;QACA;IAFC;IACD;IACA;;EAAwC","file":"../../../../../../../../../../packages/intl/number_symbols.dart.lib.js"}');
  // Exports:
  return {
