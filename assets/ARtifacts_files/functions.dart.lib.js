define(['dart_sdk', 'packages/collection/src/utils.dart'], (function load__packages__collection__src__functions_dart(dart_sdk, packages__collection__src__utils$46dart) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/collection-1.15.0-nullsafety.5/lib/src/functions.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  functions.mapMap = function mapMap(K1, V1, K2, V2, map, opts) {
    let t0, t0$;
    if (map == null) dart.nullFailed(L0, 15, 48, "map");
  ...
  functions.mergeMaps = function mergeMaps(K, V, map1, map2, opts) {
    let t0;
    if (map1 == null) dart.nullFailed(L0, 32, 37, "map1");
    if (map2 == null) dart.nullFailed(L0, 32, 53, "map2");
    let value = opts && 'value' in opts ? opts.value : null;
  ...
  functions.groupBy = function groupBy(S, T, values, key) {
    let t3, t2, t1, t0;
    if (values == null) dart.nullFailed(L0, 49, 43, "values");
    if (key == null) dart.nullFailed(L0, 49, 65, "key");
  ...
  functions.minBy = function minBy(S, T, values, orderBy, opts) {
    if (values == null) dart.nullFailed(L0, 65, 28, "values");
    if (orderBy == null) dart.nullFailed(L0, 65, 50, "orderBy");
    let compare = opts && 'compare' in opts ? opts.compare : null;
    compare == null ? compare = C0 || CT.C0 : null;
    let minValue = null;
    let minOrderBy = null;
    for (let element of values) {
  ...
  functions.maxBy = function maxBy(S, T, values, orderBy, opts) {
    if (values == null) dart.nullFailed(L0, 89, 28, "values");
    if (orderBy == null) dart.nullFailed(L0, 89, 51, "orderBy");
    let compare = opts && 'compare' in opts ? opts.compare : null;
    compare == null ? compare = C0 || CT.C0 : null;
    let maxValue = null;
    let maxOrderBy = null;
  ...
  functions.transitiveClosure = function transitiveClosure(T, graph) {
    if (graph == null) dart.nullFailed(L0, 116, 57, "graph");
    let result = new (_js_helper.LinkedMap$(T, core.Set$(T))).new();
    graph[$forEach](dart.fn((vertex, edges) => {
      if (edges == null) dart.nullFailed(L0, 122, 26, "edges");
  ...
  functions.stronglyConnectedComponents = function stronglyConnectedComponents(T, graph) {
    if (graph == null) dart.nullFailed(L0, 155, 65, "graph");
    let index = 0;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["functions.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;qDAc+C;;;QACrB;QAA0B;AAC9C,iBAAY,KAAJ,GAAG,QAAH,OAAO,SAAC,QAAQ,MAAa,MAAP,MAAM;AACpC,mBAAgB,MAAN,KAAK,SAAL,OAAS,SAAC,GAAG,aAAsB,MAAT,QAAQ;AAE5C,iBAAiB;AAGnB,IAFF,AAAI,GAAD,WAAS,SAAC,QAAQ;AACwC,MAA3D,AAAM,MAAA,QAAC,AAAK,KAAA,CAAC,MAAM,EAAE,QAAQ,GAAK,AAAO,OAAA,CAAC,MAAM,EAAE,QAAQ;;AAE5D,UAAO,OAAM;EACf;iDAOoC,MAAgB;;QAAhB;QAAgB;QAC7B;AACjB,iBAAS,mCAAa,IAAI;AAC9B,QAAI,AAAM,KAAD,IAAI,MAAM;WAAO,MAAM;YAAN;AAAQ,oBAAO,IAAI;;;;AAK3C,IAHF,AAAK,IAAD,WAAS,SAAC,KAAK;AAEyD,MAD1E,AAAM,MAAA,QAAC,GAAG,YACN,AAAO,MAAD,eAAa,GAAG,KAAI,AAAK,KAAA,CAAa,KAAZ,AAAM,MAAA,QAAC,GAAG,IAAQ,QAAQ,IAAI,QAAQ;;AAE5E,UAAO,OAAM;EACf;6CAO0C,QAAsB;;QAAtB;QAAsB;AAC1D,cAAkB;AACtB,aAAS,UAAW,OAAM;AACe,MAAZ,CAAR,KAAlB,GAAG,OAAC,AAAG,GAAA,CAAC,OAAO,QAAZ,qBAAe,aAAI,kCAAnB,mCAA2B,OAAO;;AAExC,UAAO,IAAG;EACZ;yCAU2B,QAAsB;