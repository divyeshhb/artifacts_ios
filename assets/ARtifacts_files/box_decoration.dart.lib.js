define(['dart_sdk', 'packages/flutter/src/painting/box_border.dart', 'packages/flutter/src/painting/border_radius.dart', 'packages/flutter/src/painting/box_shadow.dart', 'packages/flutter/src/painting/gradient.dart', 'packages/flutter/src/foundation/collections.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/colors.dart', 'packages/flutter/src/painting/decoration_image.dart', 'packages/flutter/src/painting/decoration.dart', 'packages/flutter/src/painting/_network_image_web.dart'], (function load__packages__flutter__src__painting__box_decoration_dart(dart_sdk, packages__flutter__src__painting__box_border$46dart, packages__flutter__src__painting__border_radius$46dart, packages__flutter__src__painting__box_shadow$46dart, packages__flutter__src__painting__gradient$46dart, packages__flutter__src__foundation__collections$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__colors$46dart, packages__flutter__src__painting__decoration_image$46dart, packages__flutter__src__painting__decoration$46dart, packages__flutter__src__painting___network_image_web$46dart) {
  ...
  var BoxDecorationN = () => (BoxDecorationN = dart.constFn(dart.nullable(box_decoration.BoxDecoration)))();
  ...
  var BorderRadiusN = () => (BorderRadiusN = dart.constFn(dart.nullable(border_radius.BorderRadius)))();
  const CT = Object.create(null);
  var L1 = "package:flutter/src/painting/box_decoration.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/painting/box_decoration.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  box_decoration.BoxDecoration = class BoxDecoration extends decoration.Decoration {
    ...
    debugAssertIsValid() {
      if (!(!dart.equals(this.shape, box_border.BoxShape.circle) || this.borderRadius == null)) dart.assertFailed(null, L0, 131, 12, "shape != BoxShape.circle ||\n          borderRadius == null");
    ...
    getClipPath(rect, textDirection) {
      let t0, t0$, t0$0;
      if (rect == null) dart.nullFailed(L0, 218, 25, "rect");
      if (textDirection == null) dart.nullFailed(L0, 218, 45, "textDirection");
      switch (this.shape) {
        case C1 || CT.C1:
        {
    ...
    scale(factor) {
      let t0;
      if (factor == null) dart.nullFailed(L0, 233, 30, "factor");
    ...
    lerpFrom(a, t) {
      if (t == null) dart.nullFailed(L0, 249, 49, "t");
      if (a == null) return this.scale(t);
      if (box_decoration.BoxDecoration.is(a)) return box_decoration.BoxDecoration.lerp(a, this, t);
      return BoxDecorationN().as(super.lerpFrom(a, t));
    }
    lerpTo(b, t) {
      if (t == null) dart.nullFailed(L0, 258, 47, "t");
      ...
      return BoxDecorationN().as(super.lerpTo(b, t));
    }
    static lerp(a, b, t) {
      if (t == null) dart.nullFailed(L0, 289, 73, "t");
    ...
    debugFillProperties(properties) {
      let t0;
      if (properties == null) dart.nullFailed(L0, 342, 56, "properties");
    ...
    hitTest(size, position, opts) {
      if (size == null) dart.nullFailed(L0, 358, 21, "size");
      if (position == null) dart.nullFailed(L0, 358, 34, "position");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      if (!(this.shape != null)) dart.assertFailed(null, L0, 359, 12, "shape != null");
      if (!dart.test(ui.Offset.zero['&'](size).contains(position))) dart.assertFailed(null, L0, 360, 12, "(Offset.zero & size).contains(position)");
      switch (this.shape) {
        case C0 || CT.C0:
        {
          if (this.borderRadius != null) {
    ...
    createBoxPainter(onChanged = null) {
      if (!(onChanged != null || this.image == null)) dart.assertFailed(null, L0, 378, 12, "onChanged != null || image == null");
  ...
  (box_decoration.BoxDecoration.new = function(opts) {
    ...
    if (shape == null) dart.nullFailed(L0, 97, 10, "shape");
    this[color$] = color;
    this[image$] = image;
    this[border$] = border;
    ...
    this[shape$] = shape;
    if (!(shape != null)) dart.assertFailed(null, L0, 98, 15, "shape != null");
    if (!(backgroundBlendMode == null || color != null || gradient != null)) dart.assertFailed("backgroundBlendMode applies to BoxDecoration's background color or " + "gradient, but no color or gradient was provided.", L0, 100, 10, "backgroundBlendMode == null || color != null || gradient != null");
  ...
  box_decoration._BoxDecorationPainter = class _BoxDecorationPainter extends decoration.BoxPainter {
    [_getBackgroundPaint](rect, textDirection) {
      if (rect == null) dart.nullFailed(L0, 393, 34, "rect");
      if (!(rect != null)) dart.assertFailed(null, L0, 394, 12, "rect != null");
      if (!(this[_decoration$].gradient != null || this[_rectForCachedBackgroundPaint] == null)) dart.assertFailed(null, L0, 395, 12, "_decoration.gradient != null || _rectForCachedBackgroundPaint == null");
    ...
    [_paintBox](canvas, rect, paint, textDirection) {
      if (canvas == null) dart.nullFailed(L0, 414, 25, "canvas");
      if (rect == null) dart.nullFailed(L0, 414, 38, "rect");
      if (paint == null) dart.nullFailed(L0, 414, 50, "paint");
      switch (this[_decoration$].shape) {
        case C1 || CT.C1:
        {
          if (!(this[_decoration$].borderRadius == null)) dart.assertFailed(null, L0, 417, 16, "_decoration.borderRadius == null");
          let center = rect.center;
          let radius = dart.notNull(rect.shortestSide) / 2.0;
    ...
    [_paintShadows](canvas, rect, textDirection) {
      if (canvas == null) dart.nullFailed(L0, 432, 29, "canvas");
      if (rect == null) dart.nullFailed(L0, 432, 42, "rect");
    ...
    [_paintBackgroundColor](canvas, rect, textDirection) {
      if (canvas == null) dart.nullFailed(L0, 442, 37, "canvas");
      if (rect == null) dart.nullFailed(L0, 442, 50, "rect");
    ...
    [_paintBackgroundImage](canvas, rect, configuration) {
      let t0, t0$;
      if (canvas == null) dart.nullFailed(L0, 448, 37, "canvas");
      if (rect == null) dart.nullFailed(L0, 448, 50, "rect");
      if (configuration == null) dart.nullFailed(L0, 448, 75, "configuration");
      ...
      switch (this[_decoration$].shape) {
        case C1 || CT.C1:
        {
          if (!(this[_decoration$].borderRadius == null)) dart.assertFailed(null, L0, 455, 16, "_decoration.borderRadius == null");
          let center = rect.center;
          let radius = dart.notNull(rect.shortestSide) / 2.0;
          let square = new ui.Rect.fromCircle({center: center, radius: radius});
    ...
    paint(canvas, offset, configuration) {
      let t0;
      if (canvas == null) dart.nullFailed(L0, 477, 21, "canvas");
      if (offset == null) dart.nullFailed(L0, 477, 36, "offset");
      if (configuration == null) dart.nullFailed(L0, 477, 63, "configuration");
      if (!(configuration != null)) dart.assertFailed(null, L0, 478, 12, "configuration != null");
      if (!(configuration.size != null)) dart.assertFailed(null, L0, 479, 12, "configuration.size != null");
      ...
      t0 == null ? null : t0.paint(canvas, rect, {shape: this[_decoration$].shape, borderRadius: BorderRadiusN().as(this[_decoration$].borderRadius), textDirection: configuration.textDirection});
    }
    toString() {
  ...
  (box_decoration._BoxDecorationPainter.new = function(_decoration, onChanged) {
    if (_decoration == null) dart.nullFailed(L0, 385, 30, "_decoration");
    this[_cachedBackgroundPaint] = null;
    this[_rectForCachedBackgroundPaint] = null;
    this[_imagePainter] = null;
    this[_decoration$] = _decoration;
    if (!(_decoration != null)) dart.assertFailed(null, L0, 386, 14, "_decoration != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["box_decoration.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA+Ie;;;;;;IAOU;;;;;;IAYN;;;;;;IAQW;;;;;;IAWL;;;;;;IAOP;;;;;;IAQC;;;;;;IAeF;;;;;;;;UAxGN;UACU;UACN;UACW;UACL;UACP;UACC;UACD;AAEV,YAAO,+CACQ,KAAN,KAAK,QAAL,OAAc,0BACR,MAAN,KAAK,SAAL,OAAc,4BACN,OAAP,MAAM,UAAN,OAAe,oCACI,OAAb,YAAY,UAAZ,OAAqB,uCACd,OAAV,SAAS,UAAT,OAAkB,mCACV,OAAT,QAAQ,UAAR,OAAiB,6CACc,OAApB,mBAAmB,UAAnB,OAA4B,0CACpC,OAAN,KAAK,UAAL,OAAc;IAEzB;;AAIE,YAAgC,aAAzB,YAAkB,+BACnB,AAAa,qBAAG;AACtB,YAAa;IACf;;;AAiFmC;iCAAQ;IAAU;gBAG/B,MAAoB;;UAApB;UAAoB;AACxC,cAAQ;;;AAES,uBAAS,AAAK,IAAD;AACb,uBAA2B,aAAlB,AAAK,IAAD,iBAAgB;AAC/B,uBAAc,gCAAmB,MAAM,UAAU,MAAM;AAClE,eAAO;;AAAQ,uBAAQ,MAAM;;;;;;AAE7B,cAAI,qBAAgB,MAClB;kBAAO;;AAAQ,2BAAqB,AAAE,AAAuB,eAArC,2BAAsB,aAAa,UAAU,IAAI;;;;AAC3E,iBAAO;;AAAQ,yBAAQ,IAAI;;;;;;AAT/B;;;IAWF;UAG2B;;;AACzB,YAAO,8CACQ,cAAK,MAAM,YAAO,MAAM,UAC9B,oBACW,0BAAK,MAAM,aAAQ,MAAM,iBACR,wCAAK,MAAM,mBAAc,MAAM,cAC7C,8BAAS,MAAM,gBAAW,MAAM,+CAC3C,OAAU,SAAM,MAAM,WACzB;IAEX;;AAGsB,YAAA,AAAU,mBAAG;IAAI;aAGH;UAAU;AAC5C,UAAI,AAAE,CAAD,IAAI,MACP,MAAO,YAAM,CAAC;AAChB,UAAM,gCAAF,CAAC,GACH,MAAqB,mCAAK,CAAC,EAAE,MAAM,CAAC;AACtC,YAA4B,qBAAf,eAAS,CAAC