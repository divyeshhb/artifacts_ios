define(['dart_sdk', 'packages/typed_data/src/typed_buffer.dart'], (function load__packages__flutter__src__foundation__serialization_dart(dart_sdk, packages__typed_data__src__typed_buffer$46dart) {
  ...
  var L1 = "package:flutter/src/foundation/serialization.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/foundation/serialization.dart";
  ...
  serialization.WriteBuffer = class WriteBuffer extends core.Object {
    ...
    putUint32(value, opts) {
      let t1;
      if (value == null) dart.nullFailed(L0, 39, 22, "value");
      let endian = opts && 'endian' in opts ? opts.endian : null;
    ...
    putInt32(value, opts) {
      let t1;
      if (value == null) dart.nullFailed(L0, 45, 21, "value");
      let endian = opts && 'endian' in opts ? opts.endian : null;
    ...
    putInt64(value, opts) {
      let t1;
      if (value == null) dart.nullFailed(L0, 51, 21, "value");
      let endian = opts && 'endian' in opts ? opts.endian : null;
    ...
    putFloat64(value, opts) {
      let t1;
      if (value == null) dart.nullFailed(L0, 57, 26, "value");
      let endian = opts && 'endian' in opts ? opts.endian : null;
      this[_alignTo](8);
  ...
  dart.setLibraryUri(serialization.WriteBuffer, L1);
  ...
  serialization.ReadBuffer = class ReadBuffer extends core.Object {
    ...
    getUint8List(length) {
      if (length == null) dart.nullFailed(L0, 161, 30, "length");
    ...
    getInt32List(length) {
      if (length == null) dart.nullFailed(L0, 168, 30, "length");
      this[_alignTo](4);
    ...
    getInt64List(length) {
      if (length == null) dart.nullFailed(L0, 176, 30, "length");
      this[_alignTo](8);
    ...
    getFloat64List(length) {
      if (length == null) dart.nullFailed(L0, 184, 34, "length");
      this[_alignTo](8);
    ...
    [_alignTo](alignment) {
      if (alignment == null) dart.nullFailed(L0, 191, 21, "alignment");
  ...
  (serialization.ReadBuffer.new = function(data) {
    if (data == null) dart.nullFailed(L0, 107, 19, "data");
    this[_position] = 0;
    this[data$] = data;
    if (!(data != null)) dart.assertFailed(null, L0, 108, 14, "data != null");
    ;
  ...
  dart.setLibraryUri(serialization.ReadBuffer, L1);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["serialization.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAwBiB;IAAiB;;;AAAjB;;IAAiB;;UAGd;AACE,MAAX,AAAE,eAAT,mBAAa,IAAI;IACnB;cAGmB;;;UAAgB;AACqB,MAAtD,AAAY,8BAAU,GAAG,KAAK,GAAS,KAAP,MAAM,QAAN,OAAiB;AACT,MAAjC,AAAE,eAAT,sBAAgB,yBAAmB,GAAG;IACxC;cAGmB;;;UAAgB;AACqB,MAAtD,AAAY,8BAAU,GAAG,KAAK,GAAS,KAAP,MAAM,QAAN,OAAiB;AACT,MAAjC,AAAE,eAAT,sBAAgB,yBAAmB,GAAG;IACxC;aAGkB;;;UAAgB;AACqB,MAArD,AAAY,6BAAS,GAAG,KAAK,GAAS,KAAP,MAAM,QAAN,OAAiB;AACR,MAAjC,AAAE,eAAT,sBAAgB,yBAAmB,GAAG;IACxC;aAGkB;;;UAAgB;AACqB,MAArD,AAAY,6BAAS,GAAG,KAAK,GAAS,KAAP,MAAM,QAAN,OAAiB;AACR,MAAjC,AAAE,eAAT,sBAAgB,yBAAmB,GAAG;IACxC;eAGuB;;;UAAgB;AAC1B,MAAX,eAAS;AAC8C,MAAvD,AAAY,+BAAW,GAAG,KAAK,GAAS,KAAP,MAAM,QAAN,OAAiB;AAChB,MAA3B,AAAE,eAAT,sBAAgB;IAClB;;UAG4B;AACL,MAAd,AAAE,eAAT,sBAAgB,IAAI;IACtB;;UAG4B;AACf,MAAX,eAAS;AACoE,MAAtE,AAAE,eAAT,sBAAgB,AAAK,AAAO,IAAR,wBAAoB,AAAK,IAAD,kBAAgB,AAAE,iBAAE,AAAK,IAAD;IACtE;;UAG4B;AACf,MAAX,eAAS;AACoE,MAAtE,AAAE