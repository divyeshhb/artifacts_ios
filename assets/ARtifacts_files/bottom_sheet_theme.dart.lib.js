define(['dart_sdk', 'packages/flutter/src/painting/borders.dart', 'packages/flutter/src/painting/colors.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__material__bottom_sheet_theme_dart(dart_sdk, packages__flutter__src__painting__borders$46dart, packages__flutter__src__painting__colors$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  var L1 = "package:flutter/src/material/bottom_sheet_theme.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/material/bottom_sheet_theme.dart";
  ...
  bottom_sheet_theme.BottomSheetThemeData = class BottomSheetThemeData extends Object_Diagnosticable$36 {
    ...
    debugFillProperties(properties) {
      ...
      properties.add(new (DiagnosticsPropertyOfShapeBorder()).new("shape", this.shape, {defaultValue: null}));
      properties.add(new (DiagnosticsPropertyOfClip()).new("clipBehavior", this.clipBehavior, {defaultValue: null}));
    }
  };
  ...
  dart.setMethodSignature(bottom_sheet_theme.BottomSheetThemeData, () => ({
    ...
    copyWith: dart.fnType(bottom_sheet_theme.BottomSheetThemeData, [], {backgroundColor: dart.nullable(ui.Color), clipBehavior: dart.nullable(ui.Clip), elevation: dart.nullable(core.double), modalBackgroundColor: dart.nullable(ui.Color), modalElevation: dart.nullable(core.double), shape: dart.nullable(borders.ShapeBorder)}, {})
  }));
  dart.setLibraryUri(bottom_sheet_theme.BottomSheetThemeData, L1);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["bottom_sheet_theme.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;IAyCe;;;;;;IAOC;;;;;;IAID;;;;;;IAIC;;;;;;IAMK;;;;;;IAKP;;;;;;;;UAKH;UACC;UACD;UACC;UACK;UACP;AAEN,YAAO,oEAC4B,KAAhB,eAAe,QAAf,OAAwB,wCACpB,MAAV,SAAS,SAAT,OAAkB,8CACc,OAArB,oBAAoB,UAApB,OAA6B,oDACpB,OAAf,cAAc,UAAd,OAAuB,qCAC1B,OAAN,KAAK,UAAL,OAAc,mCACM,OAAb,YAAY,UAAZ,OAAqB;IAEvC;gBAOwD,GAAyB,GAAU;;;AACzF,YAAO,AAAE,CAAD,IAAI;AACZ,UAAI,AAAE,CAAD,IAAI,QAAQ,AAAE,CAAD,IAAI,MACpB,MAAO;AACT,YAAO,mEACkB,oBAAK,CAAC,eAAD,OAAG,4BAAiB,CAAC,gBAAD,OAAG,sBAAiB,CAAC,cAC1D,sBAAW,CAAC,iBAAD,OAAG,yBAAW,CAAC,iBAAD,OAAG,iBAAW,CAAC,yBACvB,sBAAK,CAAC,iBAAD,OAAG,oCAAsB,CAAC,iBAAD,OAAG,4BAAsB,CAAC,mBACpE,sBAAW,CAAC,iBAAD,OAAG,8BAAgB,CAAC,iBAAD,OAAG,sBAAgB,CAAC,UAC/C,iCAAK,CAAC,iBAAD,OAAG,qBAAO,CAAC,iBAAD,OAAG,aAAO,CAAC,iBAC7B,aAAF,CAAC,IAAG,cAAM,CAAC,iBAAD,OAAG,6BAAe,CAAC,iBAAD,OAAG;IAEjD;;AAIE,YAAO,eACL,sBACA,gBACA,2BACA,qBACA,YACA;IAEJ;;UAGwB;AACtB,UAAI,AAAU,SAAM,KAAK,EACvB,MAAO;AACT,uBAAU,iBAAN,KAAK,GAAgB,qBACvB,MAAO;AACT,YAAa,AAMT,4CANG,KAAK,KACiB,YAAtB,AAAM,KAAD,kBAAoB,yBACzB,AAAM,AAAU,KAAX,cAAc,kBACQ,YAA3B,AAAM,KAAD,uBAAyB,8BAC9B,AAAM,AAAe,KAAhB,mBAAmB,uBACZ,YAAZ,AAAM,KAAD,QAAU,eACI,YAAnB,AAAM,KAAD,eAAiB;IAC/B;;UAGqD;AACd,MAA/B,0BAAoB,UAAU;AACiD,MAArF,AAAW,UAAD,KAAK,6BAAc,mBAAmB,qCAA+B;AACL,MAA1E,AAAW,UAAD,KAAK,mCAAe,aAAa,+BAAyB;AAC2B,MAA/F,AAAW,UAAD,KAAK,6BAAc,wBAAwB,0CAAoC;AACL,MAApF,AAAW,UAAD,KAAK,mCAAe,kBAAkB,oCAA8B;AACM,MAApF,AAAW,UAAD,KAAK,6CAAiC,SAAS,2BAAqB;AACa,MAA3F,AAAW,UAAD,KAAK,sCAA0B,gBAAgB,kCAA4B;IACvF;;;QAlHO;QACA;QACA;QACA;QACA;QACA;IALA;IACA;IACA;IACA;IACA;IACA;;EACL","file":"../../../../../../../../../../packages/flutter/src/material/bottom_sheet_theme.dart.lib.js"}');
  // Exports:
  return {
