define(['dart_sdk'], (function load__packages__typed_data__src__typed_buffer_dart(dart_sdk) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/typed_data-1.3.0-nullsafety.5/lib/src/typed_buffer.dart";
  ...
  typed_buffer.TypedDataBuffer$ = dart.generic(E => {
    ...
    class TypedDataBuffer extends collection.ListBase$(E) {
      ...
      _get(index) {
        if (index == null) dart.nullFailed(L0, 31, 21, "index");
      ...
      _set(index, value$) {
        let value = value$;
        if (index == null) dart.nullFailed(L0, 37, 25, "index");
        E.as(value);
        if (dart.notNull(index) >= dart.notNull(this.length)) dart.throw(new core.IndexError.new(index, this));
      ...
      set length(newLength) {
        if (newLength == null) dart.nullFailed(L0, 43, 18, "newLength");
      ...
      addAll(values, start = 0, end = null) {
        ...
        if (values == null) dart.nullFailed(L0, 85, 27, "values");
        if (start == null) dart.nullFailed(L0, 85, 40, "start");
      ...
      insertAll(index, values, start = 0, end = null) {
        let t0;
        if (index == null) dart.nullFailed(L0, 104, 22, "index");
        IterableOfE().as(values);
        if (values == null) dart.nullFailed(L0, 104, 41, "values");
        if (start == null) dart.nullFailed(L0, 104, 54, "start");
      ...
      static _reverse(buffer, start, end) {
        if (buffer == null) dart.nullFailed(L0, 162, 29, "buffer");
        if (start == null) dart.nullFailed(L0, 162, 41, "start");
        if (end == null) dart.nullFailed(L0, 162, 52, "end");
      ...
      [_addAll](values, start = 0, end = null) {
        if (values == null) dart.nullFailed(L0, 179, 28, "values");
        if (start == null) dart.nullFailed(L0, 179, 41, "start");
      ...
      [_insertKnownLength](index, values, start, end) {
        if (index == null) dart.nullFailed(L0, 200, 31, "index");
        if (values == null) dart.nullFailed(L0, 200, 50, "values");
        if (start == null) dart.nullFailed(L0, 200, 62, "start");
        if (end == null) dart.nullFailed(L0, 200, 73, "end");
      ...
      insert(index, element) {
        if (index == null) dart.nullFailed(L0, 218, 19, "index");
        E.as(element);
      ...
      [_ensureCapacity](requiredCapacity) {
        if (requiredCapacity == null) dart.nullFailed(L0, 239, 28, "requiredCapacity");
      ...
      [_grow](length) {
        let t0;
        if (length == null) dart.nullFailed(L0, 265, 18, "length");
      ...
      setRange(start, end, source, skipCount = 0) {
        if (start == null) dart.nullFailed(L0, 270, 21, "start");
        if (end == null) dart.nullFailed(L0, 270, 32, "end");
        IterableOfE().as(source);
        if (source == null) dart.nullFailed(L0, 270, 49, "source");
        if (skipCount == null) dart.nullFailed(L0, 270, 62, "skipCount");
      ...
      [_setRange](start, end, source, skipCount) {
        if (start == null) dart.nullFailed(L0, 276, 22, "start");
        if (end == null) dart.nullFailed(L0, 276, 33, "end");
        if (source == null) dart.nullFailed(L0, 276, 50, "source");
        if (skipCount == null) dart.nullFailed(L0, 276, 62, "skipCount");
    ...
    (TypedDataBuffer.new = function(buffer) {
      if (buffer == null) dart.nullFailed(L0, 23, 27, "buffer");
      this[_buffer] = buffer;
  ...
  (typed_buffer._IntBuffer.new = function(buffer) {
    if (buffer == null) dart.nullFailed(L0, 311, 24, "buffer");
  ...
  (typed_buffer._FloatBuffer.new = function(buffer) {
    if (buffer == null) dart.nullFailed(L0, 318, 29, "buffer");
  ...
  typed_buffer.Uint8Buffer = class Uint8Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 328, 31, "size");
      return _native_typed_data.NativeUint8List.new(size);
    }
  };
  (typed_buffer.Uint8Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 325, 20, "initialLength");
  ...
  typed_buffer.Int8Buffer = class Int8Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 335, 30, "size");
      return _native_typed_data.NativeInt8List.new(size);
    }
  };
  (typed_buffer.Int8Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 332, 19, "initialLength");
  ...
  typed_buffer.Int16Buffer = class Int16Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 357, 31, "size");
      return _native_typed_data.NativeInt16List.new(size);
    }
  };
  (typed_buffer.Int16Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 354, 20, "initialLength");
  ...
  typed_buffer.Int32Buffer = class Int32Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 371, 31, "size");
      return _native_typed_data.NativeInt32List.new(size);
    }
  };
  (typed_buffer.Int32Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 368, 20, "initialLength");
  ...
  typed_buffer.Uint64Buffer = class Uint64Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 378, 32, "size");
      return typed_data.Uint64List.new(size);
    }
  };
  (typed_buffer.Uint64Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 375, 21, "initialLength");
  ...
  typed_buffer.Int64Buffer = class Int64Buffer extends typed_buffer._IntBuffer {
    [_createBuffer](size) {
      if (size == null) dart.nullFailed(L0, 385, 31, "size");
      return typed_data.Int64List.new(size);
    }
  };
  (typed_buffer.Int64Buffer.new = function(initialLength = 0) {
    if (initialLength == null) dart.nullFailed(L0, 382, 20, "initialLength");
