define(['dart_sdk', 'packages/collection/src/utils.dart'], (function load__packages__collection__src__priority_queue_dart(dart_sdk, packages__collection__src__utils$46dart) {
  ...
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/collection-1.15.0-nullsafety.5/lib/src/priority_queue.dart";
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(utils.defaultCompare, ObjectNAndObjectNToint());
    },
    get C1() {
  ...
  priority_queue.HeapPriorityQueue$ = dart.generic(E => {
    ...
    class HeapPriorityQueue extends core.Object {
      ...
      [_elementAt](index) {
        let t0;
        if (index == null) dart.nullFailed(L1, 207, 20, "index");
      ...
      addAll(elements) {
        ...
        if (elements == null) dart.nullFailed(L1, 216, 27, "elements");
        let modified = 0;
      ...
      [_bubbleUp](element, index) {
        let t2, t1;
        if (index == null) dart.nullFailed(L1, 396, 33, "index");
      ...
      [_bubbleDown](element, index) {
        ...
        if (index == null) dart.nullFailed(L1, 412, 35, "index");
    ...
    (HeapPriorityQueue.new = function(comparison = null) {
      ...
      this[comparison$] = (t0 = comparison, t0 == null ? C0 || CT.C0 : t0);
      ;
  ...
  priority_queue._UnorderedElementsIterable$ = dart.generic(E => {
    ...
    (_UnorderedElementsIterable.new = function(_queue) {
      if (_queue == null) dart.nullFailed(L1, 464, 35, "_queue");
      this[_queue$] = _queue;
    ...
    dart.setLibraryUri(_UnorderedElementsIterable, L0);
  ...
  priority_queue._UnorderedElementsIterator$ = dart.generic(E => {
    ...
    (_UnorderedElementsIterator.new = function(_queue) {
      if (_queue == null) dart.nullFailed(L1, 475, 35, "_queue");
      this[_current] = null;
      this[_index] = -1;
      this[_queue$] = _queue;
    ...
    dart.setLibraryUri(_UnorderedElementsIterator, L0);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["priority_queue.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAmLsB;;;;;;mBA2BH;;;AAAU,aAAA,AAAM,qBAAC,KAAK;qBAAN,OAAiB,KAAL;MAAU;;aAG5C;AACW,QAApB,2BAAkB,aAAlB,4BAAkB;AACL,QAAb,WAAK,OAAO;MACd;;yBAGwB;;AAClB,uBAAW;AACf,iBAAS,UAAW,SAAQ;AACd,UAAZ,WAAW;AACE,UAAb,WAAK,OAAO;;AAEgB,QAA9B,2BAAmB,aAAnB,4BAAsB,QAAQ;MAChC;;AAIsB,QAApB,2BAAkB,aAAlB,4BAAkB;AACD,QAAjB;AACW,QAAX,gBAAU;MACZ;;aAGgB;AAAW,cAAgB,cAAhB,cAAQ,MAAM,MAAK;MAAC;;AAUV,yDAA8B;MAAK;;AAItE,YAAI,AAAQ,kBAAG,GAAG,AAA8B,WAAxB,wBAAW;AACnC,cAAO,kBAAW;MACpB;;AAGoB,cAAA,AAAQ,mBAAG;MAAC;;AAGT,cAAA,AAAQ,mBAAG;MAAC;;AAGjB;MAAO;aAGX;;;AACR,oBAAQ,cAAQ,OAAO;AAC3B,YAAU,aAAN,KAAK,IAAG,GAAG,MAAO;AACF,QAApB,2BAAkB,aAAlB,4BAAkB;AACd,mBAAO;AACX,YAAU,aAAN,KAAK,iBAAG;AACN,2BAAkB,IAA