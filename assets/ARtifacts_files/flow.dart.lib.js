define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/change_notifier.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__rendering__flow_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__change_notifier$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__debug$46dart) {
  ...
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/rendering/flow.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  flow.FlowDelegate = class FlowDelegate extends core.Object {
    ...
    getSize(constraints) {
      if (constraints == null) dart.nullFailed(L1, 75, 31, "constraints");
      return constraints.biggest;
    }
    getConstraintsForChild(i, constraints) {
      if (i == null) dart.nullFailed(L1, 90, 45, "i");
      if (constraints == null) dart.nullFailed(L1, 90, 63, "constraints");
      return constraints;
    }
    shouldRelayout(oldDelegate) {
      flow.FlowDelegate.as(oldDelegate);
      if (oldDelegate == null) dart.nullFailed(L1, 114, 46, "oldDelegate");
      return false;
    }
    toString() {
  ...
  flow.RenderFlow = class RenderFlow extends RenderBox_RenderBoxContainerDefaultsMixin$36 {
    setupParentData(child) {
      ...
      if (child == null) dart.nullFailed(L1, 194, 34, "child");
    ...
    set delegate(newDelegate) {
      let t0, t0$;
      if (newDelegate == null) dart.nullFailed(L1, 210, 29, "newDelegate");
      if (!(newDelegate != null)) dart.assertFailed(null, L1, 211, 12, "newDelegate != null");
    ...
    set clipBehavior(value) {
      if (value == null) dart.nullFailed(L1, 233, 25, "value");
      if (!(value != null)) dart.assertFailed(null, L1, 234, 12, "value != null");
    ...
    attach(owner) {
      ...
      if (owner == null) dart.nullFailed(L1, 243, 29, "owner");
      super.attach(owner);
    ...
    [_getSize](constraints) {
      if (constraints == null) dart.nullFailed(L1, 254, 32, "constraints");
      if (!dart.test(constraints.debugAssertIsValid())) dart.assertFailed(null, L1, 255, 12, "constraints.debugAssertIsValid()");
    ...
    getChildSize(i) {
      if (i == null) dart.nullFailed(L1, 332, 26, "i");
    ...
    paintChild(i, opts) {
      if (i == null) dart.nullFailed(L1, 339, 23, "i");
      let transform = opts && 'transform' in opts ? opts.transform : null;
      let opacity = opts && 'opacity' in opts ? opts.opacity : 1;
      if (opacity == null) dart.nullFailed(L1, 339, 55, "opacity");
      ...
      if (opacity === 1.0) {
        ...
        dart.nullCheck(this[_paintingContext]).pushOpacity(dart.nullCheck(this[_paintingOffset]), ui.Color.getAlphaFromOpacity(opacity), dart.fn((context, offset) => {
          if (context == null) dart.nullFailed(L1, 367, 111, "context");
          if (offset == null) dart.nullFailed(L1, 367, 127, "offset");
    ...
    [_paintWithDelegate](context, offset) {
      if (context == null) dart.nullFailed(L1, 373, 43, "context");
      if (offset == null) dart.nullFailed(L1, 373, 59, "offset");
    ...
    paint(context, offset) {
      if (context == null) dart.nullFailed(L1, 390, 30, "context");
      if (offset == null) dart.nullFailed(L1, 390, 46, "offset");
    ...
    hitTestChildren(result, opts) {
      if (result == null) dart.nullFailed(L1, 403, 41, "result");
      let position = opts && 'position' in opts ? opts.position : null;
      if (position == null) dart.nullFailed(L1, 403, 67, "position");
      ...
      for (let i = dart.notNull(this[_lastPaintOrder][$length]) - 1; i >= 0; i = i - 1) {
        ...
        let absorbed = result.addWithPaintTransform({transform: transform, position: position, hitTest: dart.fn((result, position) => {
            if (result == null) dart.nullFailed(L1, 417, 36, "result");
    ...
    applyPaintTransform(child, transform) {
      box.RenderBox.as(child);
      if (child == null) dart.nullFailed(L1, 428, 38, "child");
      if (transform == null) dart.nullFailed(L1, 428, 53, "transform");
      let childParentData = flow.FlowParentData.as(dart.nullCheck(child.parentData));
  ...
  (flow.RenderFlow.new = function(opts) {
    ...
    if (delegate == null) dart.nullFailed(L1, 184, 27, "delegate");
    let clipBehavior = opts && 'clipBehavior' in opts ? opts.clipBehavior : C0 || CT.C0;
    if (clipBehavior == null) dart.nullFailed(L1, 185, 10, "clipBehavior");
    ...
    if (!(clipBehavior != null)) dart.assertFailed(null, L1, 187, 15, "clipBehavior != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["flow.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EA4CA;;;;;;;IAkBoB;;;;;;;UAYU;AAAgB,YAAA,AAAY,YAAD;IAAQ;2BAerB,GAAkB;UAAlB;UAAkB;AAAgB,wBAAW;;;2BAwB5C;;AAAgB;IAAK;;AAsB3C,sCAAkB,MAAM;IAAe;;;QA3E3B;IAAsB,kBAAE,OAAO;;;;;;;;;;;;;;;;;;;;IAsFvD;;;EACX;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;uBA8CiC;;AACX,4BAAkB,AAAM,KAAD;AACzC,UAAoB,uBAAhB,eAAe;AACgB,QAAjC,AAAgB,eAAD,eAAc;;AAEM,QAAnC,AAAM,KAAD,cAAc;IACvB;;AAG6B;IAAS;iBAOZ;;;AACxB,YAAO,AAAY,WAAD,IAAI;AACtB,UAAc,YAAV,iBAAa,WAAW,GAC1B;AACiB,wBAAc;AACV,MAAvB,kBAAY,WAAW;AAEvB,uBAAgB,iBAAZ,WAAW,GAA4B,iBAAZ,WAAW,gBAAgB,AAAY,WAAD,gBAAgB,WAAW;AAC7E,QAAjB;UACG,eAAI,AAAY,WAAD,eAAe,WAAW,IAC5C,AAAgB;AAElB,oBAAI;AACkD,aAApD,AAAY,WAAD;qBAAC,OAAU,4BAAe;AACY,cAAjD,AAAY,WAAD;sBAAC,OAAU,0BAAY;;IAEtC;;AAKyB;IAAa;;UAEhB;AACpB,YAAO,AAAM,KAAD,IAAI;AAChB,uBAAI,KAAK,EAAI;AACU,QAArB,sBAAgB,KAAK;AACL,QAAhB;AAC0B,QAA1B;;IAEJ;WAG0B;;;;AACL,MAAb,aA