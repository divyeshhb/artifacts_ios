define(['dart_sdk', 'packages/path/src/path_set.dart', 'packages/collection/src/functions.dart', 'packages/term_glyph/src/generated/top_level.dart'], (function load__packages__source_span__src__location_mixin_dart(dart_sdk, packages__path__src__path_set$46dart, packages__collection__src__functions$46dart, packages__term_glyph__src__generated__top_level$46dart) {
  ...
  var JSArrayOf_Highlight = () => (JSArrayOf_Highlight = dart.constFn(_interceptors.JSArray$(highlighter._Highlight)))();
  var StringN = () => (StringN = dart.constFn(dart.nullable(core.String)))();
  var VoidToStringN = () => (VoidToStringN = dart.constFn(dart.fnType(StringN(), [])))();
  var _HighlightTobool = () => (_HighlightTobool = dart.constFn(dart.fnType(core.bool, [highlighter._Highlight])))();
  var _LineToint = () => (_LineToint = dart.constFn(dart.fnType(core.int, [highlighter._Line])))();
  var TAndTToT = () => (TAndTToT = dart.constFn(dart.gFnType(T => [T, [T, T]], T => [core.num])))();
  var UriN = () => (UriN = dart.constFn(dart.nullable(core.Uri)))();
  var _LineToUriN = () => (_LineToUriN = dart.constFn(dart.fnType(UriN(), [highlighter._Line])))();
  var _HighlightToUriN = () => (_HighlightToUriN = dart.constFn(dart.fnType(UriN(), [highlighter._Highlight])))();
  var _HighlightAnd_HighlightToint = () => (_HighlightAnd_HighlightToint = dart.constFn(dart.fnType(core.int, [highlighter._Highlight, highlighter._Highlight])))();
  var JSArrayOf_Line = () => (JSArrayOf_Line = dart.constFn(_interceptors.JSArray$(highlighter._Line)))();
  var ListOf_Line = () => (ListOf_Line = dart.constFn(core.List$(highlighter._Line)))();
  var ListOf_Highlight = () => (ListOf_Highlight = dart.constFn(core.List$(highlighter._Highlight)))();
  var ListOf_HighlightToListOf_Line = () => (ListOf_HighlightToListOf_Line = dart.constFn(dart.fnType(ListOf_Line(), [ListOf_Highlight()])))();
  var _HighlightN = () => (_HighlightN = dart.constFn(dart.nullable(highlighter._Highlight)))();
  var ListOf_HighlightN = () => (ListOf_HighlightN = dart.constFn(core.List$(_HighlightN())))();
  var VoidTovoid = () => (VoidTovoid = dart.constFn(dart.fnType(dart.void, [])))();
  var VoidToSourceSpanWithContext = () => (VoidToSourceSpanWithContext = dart.constFn(dart.fnType(span_with_context.SourceSpanWithContext, [])))();
  var MapOfSourceSpan$String = () => (MapOfSourceSpan$String = dart.constFn(core.Map$(span.SourceSpan, core.String)))();
  var StringAndStringAndMapOfSourceSpan$String__ToString = () => (StringAndStringAndMapOfSourceSpan$String__ToString = dart.constFn(dart.fnType(core.String, [core.String, core.String, MapOfSourceSpan$String()], {color: core.bool, primaryColor: StringN(), secondaryColor: StringN()}, {})))();
  var StringAndMapOfSourceSpan$String__ToString = () => (StringAndMapOfSourceSpan$String__ToString = dart.constFn(dart.fnType(core.String, [core.String, MapOfSourceSpan$String()], {color: core.bool, primaryColor: StringN(), secondaryColor: StringN()}, {})))();
  var intTovoid = () => (intTovoid = dart.constFn(dart.fnType(dart.void, [core.int])))();
  var intN = () => (intN = dart.constFn(dart.nullable(core.int)))();
  var intAndintNToSourceSpan = () => (intAndintNToSourceSpan = dart.constFn(dart.fnType(span.SourceSpan, [core.int], [intN()])))();
  var JSArrayOfint = () => (JSArrayOfint = dart.constFn(_interceptors.JSArray$(core.int)))();
  var intAndintNToFileSpan = () => (intAndintNToFileSpan = dart.constFn(dart.fnType(file.FileSpan, [core.int], [intN()])))();
  const CT = Object.create(null);
  var L8 = "package:source_span/src/span_with_context.dart";
  var L4 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/utils.dart";
  var L5 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/span_with_context.dart";
  var L3 = "package:source_span/src/span_mixin.dart";
  var L7 = "package:source_span/src/span.dart";
  var L11 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/location.dart";
  var L9 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/highlighter.dart";
  var L12 = "package:source_span/src/location.dart";
  var L14 = "package:source_span/src/file.dart";
  var L10 = "package:source_span/src/highlighter.dart";
  var L13 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/file.dart";
  var L6 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/span.dart";
  var L2 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/span_mixin.dart";
  var L1 = "package:source_span/src/location_mixin.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/source_span-1.8.0-nullsafety.4/lib/src/location_mixin.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  location_mixin.SourceLocationMixin = class SourceLocationMixin extends core.Object {
    ...
    distance(other) {
      if (other == null) dart.nullFailed(L0, 24, 31, "other");
    ...
    compareTo(other) {
      ...
      if (other == null) dart.nullFailed(L0, 36, 32, "other");
      if (!dart.equals(this.sourceUrl, other.sourceUrl)) {
        dart.throw(new core.ArgumentError.new("Source URLs \"" + dart.str(this.sourceUrl) + "\" and " + "\"" + dart.str(other.sourceUrl) + "\" don't match."));
      }
  ...
  dart.setLibraryUri(location_mixin.SourceLocationMixin, L1);
  ...
  span_mixin.SourceSpanMixin = class SourceSpanMixin extends core.Object {
    ...
    message(message, opts) {
      let t0, t0$;
      if (message == null) dart.nullFailed(L2, 53, 25, "message");
  ...
  dart.setLibraryUri(span_mixin.SourceSpanMixin, L3);
  ...
  utils.min = function min(T, obj1, obj2) {
    if (obj1 == null) dart.nullFailed(L4, 9, 31, "obj1");
    if (obj2 == null) dart.nullFailed(L4, 9, 39, "obj2");
    return dart.notNull(obj1[$compareTo](obj2)) > 0 ? obj2 : obj1;
  };
  utils.max = function max(T, obj1, obj2) {
    if (obj1 == null) dart.nullFailed(L4, 14, 31, "obj1");
    if (obj2 == null) dart.nullFailed(L4, 14, 39, "obj2");
    return dart.notNull(obj1[$compareTo](obj2)) > 0 ? obj1 : obj2;
  };
  utils.isAllTheSame = function isAllTheSame(iter) {
    if (iter == null) dart.nullFailed(L4, 19, 36, "iter");
    let lastValue = null;
  ...
  utils.replaceWithNull = function replaceWithNull(E, list, element) {
    if (list == null) dart.nullFailed(L4, 42, 34, "list");
  ...
  utils.countCodeUnits = function countCodeUnits(string, codeUnit) {
    if (string == null) dart.nullFailed(L4, 52, 27, "string");
    if (codeUnit == null) dart.nullFailed(L4, 52, 39, "codeUnit");
    let count = 0;
  ...
  utils.findLineStart = function findLineStart(context, text, column) {
    if (context == null) dart.nullFailed(L4, 64, 27, "context");
    if (text == null) dart.nullFailed(L4, 64, 43, "text");
    if (column == null) dart.nullFailed(L4, 64, 53, "column");
    if (text[$isEmpty]) {
  ...
  (span.SourceSpanBase.new = function(start, end, text) {
    if (start == null) dart.nullFailed(L6, 103, 23, "start");
    if (end == null) dart.nullFailed(L6, 103, 35, "end");
    if (text == null) dart.nullFailed(L6, 103, 45, "text");
    this[start$] = start;
    this[end$] = end;
    this[text$] = text;
  ...
  dart.setLibraryUri(span.SourceSpanBase, L7);
  ...
  (span_with_context.SourceSpanWithContext.new = function(start, end, text, _context) {
    if (start == null) dart.nullFailed(L5, 25, 22, "start");
    if (end == null) dart.nullFailed(L5, 25, 44, "end");
    if (text == null) dart.nullFailed(L5, 25, 56, "text");
    if (_context == null) dart.nullFailed(L5, 25, 67, "_context");
  ...
  dart.setLibraryUri(span_with_context.SourceSpanWithContext, L8);
  ...
  highlighter.Highlighter = class Highlighter extends core.Object {
    static _contiguous(lines) {
      if (lines == null) dart.nullFailed(L9, 115, 39, "lines");
    ...
    static _collateLines(highlights) {
      if (highlights == null) dart.nullFailed(L9, 129, 53, "highlights");
      let highlightsByUrl = functions.groupBy(highlighter._Highlight, UriN(), highlights, dart.fn(highlight => {
        if (highlight == null) dart.nullFailed(L9, 131, 22, "highlight");
        return highlight.span.sourceUrl;
      }, _HighlightToUriN()));
      for (let list of highlightsByUrl[$values]) {
        list[$sort](dart.fn((highlight1, highlight2) => {
          if (highlight1 == null) dart.nullFailed(L9, 133, 18, "highlight1");
          if (highlight2 == null) dart.nullFailed(L9, 133, 30, "highlight2");
          return highlight1.span.compareTo(highlight2.span);
        }, _HighlightAnd_HighlightToint()));
      }
      return highlightsByUrl[$values][$expand](highlighter._Line, dart.fn(highlightsForFile => {
        if (highlightsForFile == null) dart.nullFailed(L9, 137, 43, "highlightsForFile");
        ...
        for (let line of lines) {
          activeHighlights[$removeWhere](dart.fn(highlight => {
            if (highlight == null) dart.nullFailed(L9, 166, 39, "highlight");
    ...
    highlight() {
      ...
      let highlightsByColumn = ListOf_HighlightN().filled(this[_maxMultilineSpans], null);
      for (let i = 0; i < dart.notNull(this[_lines$][$length]); i = i + 1) {
        ...
        let primaryIdx = line.highlights[$indexWhere](dart.fn(highlight => {
          if (highlight == null) dart.nullFailed(L9, 230, 39, "highlight");
    ...
    [_writeMultilineHighlights](line, highlightsByColumn, opts) {
      let t1, t1$;
      if (line == null) dart.nullFailed(L9, 282, 13, "line");
      if (highlightsByColumn == null) dart.nullFailed(L9, 282, 37, "highlightsByColumn");
      ...
      for (let highlight of highlightsByColumn) {
        ...
        if (current != null && dart.equals(highlight, current)) {
          foundCurrent = true;
          if (!(startLine == line.number || endLine == line.number)) dart.assertFailed(null, L9, 300, 16, "startLine == line.number || endLine == line.number");
          this[_colorize](dart.fn(() => {
            this[_buffer].write(startLine == line.number ? top_level.topLeftCorner : top_level.bottomLeftCorner);
          }, VoidTovoid()), {color: currentColor});
          ...
          this[_colorize](dart.fn(() => {
            ...
            if (current != null) {
              ...
              }, VoidTovoid()), {color: openedOnThisLineColor});
          ...
          }, VoidTovoid()), {color: dart.test(highlight.isPrimary) ? this[_primaryColor$] : this[_secondaryColor$]});
        }
      }
    }
    [_writeHighlightedText](text, startColumn, endColumn, opts) {
      if (text == null) dart.nullFailed(L9, 347, 37, "text");
      if (startColumn == null) dart.nullFailed(L9, 347, 47, "startColumn");
      if (endColumn == null) dart.nullFailed(L9, 347, 64, "endColumn");
      let color = opts && 'color' in opts ? opts.color : null;
    ...
    [_writeIndicator](line, highlight, highlightsByColumn) {
      if (line == null) dart.nullFailed(L9, 360, 13, "line");
      if (highlight == null) dart.nullFailed(L9, 360, 30, "highlight");
      if (highlightsByColumn == null) dart.nullFailed(L9, 360, 59, "highlightsByColumn");
    ...
    [_writeUnderline](line, span, character) {
      let t1;
      if (line == null) dart.nullFailed(L9, 411, 30, "line");
      if (span == null) dart.nullFailed(L9, 411, 47, "span");
      if (character == null) dart.nullFailed(L9, 411, 60, "character");
      if (!!dart.test(utils.isMultiline(span))) dart.assertFailed(null, L9, 412, 12, "!isMultiline(span)");
      if (!line.text[$contains](span.text)) dart.assertFailed(null, L9, 413, 12, "line.text.contains(span.text)");
    ...
    [_writeArrow](line, column, opts) {
      let t1;
      if (line == null) dart.nullFailed(L9, 434, 26, "line");
      if (column == null) dart.nullFailed(L9, 434, 36, "column");
      let beginning = opts && 'beginning' in opts ? opts.beginning : true;
      if (beginning == null) dart.nullFailed(L9, 434, 50, "beginning");
    ...
    [_writeText](text) {
      if (text == null) dart.nullFailed(L9, 449, 26, "text");
    ...
    [_writeSidebar](opts) {
      ...
      if (!(line == null || text == null)) dart.assertFailed(null, L9, 465, 12, "line == null || text == null");
      ...
      }, VoidTovoid()), {color: "[34m"});
    }
    [_countTabs](text) {
      if (text == null) dart.nullFailed(L9, 478, 25, "text");
      let count = 0;
      for (let char of text[$codeUnits]) {
    ...
    [_isOnlyWhitespace](text) {
      if (text == null) dart.nullFailed(L9, 487, 33, "text");
      for (let char of text[$codeUnits]) {
    ...
    [_colorize](callback, opts) {
      if (callback == null) dart.nullFailed(L9, 496, 34, "callback");
      let color = opts && 'color' in opts ? opts.color : null;
  ...
  (highlighter.Highlighter.new = function(span, opts) {
    if (span == null) dart.nullFailed(L9, 61, 26, "span");
    let color = opts && 'color' in opts ? opts.color : null;
  ...
  (highlighter.Highlighter.multiple = function(primarySpan, primaryLabel, secondarySpans, opts) {
    let t1, t1$;
    if (primarySpan == null) dart.nullFailed(L9, 83, 35, "primarySpan");
    if (primaryLabel == null) dart.nullFailed(L9, 83, 55, "primaryLabel");
    if (secondarySpans == null) dart.nullFailed(L9, 84, 31, "secondarySpans");
    let color = opts && 'color' in opts ? opts.color : false;
    if (color == null) dart.nullFailed(L9, 85, 13, "color");
    ...
    highlighter.Highlighter.__.call(this, highlighter.Highlighter._collateLines((() => {
      let t0 = JSArrayOf_Highlight().of([new highlighter._Highlight.new(primarySpan, {label: primaryLabel, primary: true})]);
      for (let entry of secondarySpans[$entries])
        t0.push(new highlighter._Highlight.new(entry.key, {label: entry.value}));
      return t0;
  ...
  (highlighter.Highlighter.__ = function(_lines, _primaryColor, _secondaryColor) {
    if (_lines == null) dart.nullFailed(L9, 95, 22, "_lines");
    ...
    this[_maxMultilineSpans] = _lines[$map](core.int, dart.fn(line => {
      if (line == null) dart.nullFailed(L9, 106, 19, "line");
      return line.highlights[$where](dart.fn(highlight => {
        if (highlight == null) dart.nullFailed(L9, 107, 25, "highlight");
        return utils.isMultiline(highlight.span);
      }, _HighlightTobool()))[$length];
    }, _LineToint()))[$reduce](dart.gbind(C0 || CT.C0, core.int));
    this[_multipleFiles] = !dart.test(utils.isAllTheSame(_lines[$map](UriN(), dart.fn(line => {
      if (line == null) dart.nullFailed(L9, 111, 39, "line");
      return line.url;
    }, _LineToUriN()))[$whereType](core.Uri)));
    ;
  }).prototype = highlighter.Highlighter.prototype;
  ...
  dart.setLibraryUri(highlighter.Highlighter, L10);
  ...
  highlighter._Highlight = class _Highlight extends core.Object {
    static _normalizeContext(span) {
      if (span == null) dart.nullFailed(L9, 537, 61, "span");
    ...
    static _normalizeNewlines(span) {
      if (span == null) dart.nullFailed(L9, 553, 73, "span");
      let text = span.text;
      if (!text[$contains]("\r\n")) return span;
    ...
    static _normalizeTrailingNewline(span) {
      if (span == null) dart.nullFailed(L9, 579, 29, "span");
    ...
    static _normalizeEndOfLine(span) {
      if (span == null) dart.nullFailed(L9, 607, 74, "span");
    ...
    static _lastLineLength(text) {
      if (text == null) dart.nullFailed(L9, 629, 37, "text");
      if (text[$isEmpty]) {
        return 0;
    ...
    static _isTextAtEndOfContext(span) {
      if (span == null) dart.nullFailed(L9, 642, 59, "span");
  ...
  (highlighter._Highlight.new = function(span, opts) {
    if (span == null) dart.nullFailed(L9, 522, 25, "span");
    let label = opts && 'label' in opts ? opts.label : null;
    let primary = opts && 'primary' in opts ? opts.primary : false;
    if (primary == null) dart.nullFailed(L9, 522, 49, "primary");
    this.label = label;
    this.span = dart.fn(() => {
  ...
  dart.setLibraryUri(highlighter._Highlight, L10);
  ...
  (highlighter._Line.new = function(text, number, url) {
    if (text == null) dart.nullFailed(L9, 675, 14, "text");
    if (number == null) dart.nullFailed(L9, 675, 25, "number");
  ...
  dart.setLibraryUri(highlighter._Line, L10);
  ...
  span.SourceSpan = class SourceSpan extends core.Object {
    static new(start, end, text) {
      if (start == null) dart.nullFailed(L6, 40, 37, "start");
      if (end == null) dart.nullFailed(L6, 40, 59, "end");
      if (text == null) dart.nullFailed(L6, 40, 71, "text");
  ...
  dart.setLibraryUri(span.SourceSpan, L7);
  span['SourceSpanExtension|messageMultiple'] = function SourceSpanExtension$124messageMultiple($this, message, label, secondarySpans, opts) {
    let t2, t2$;
    if ($this == null) dart.nullFailed(L6, 140, 10, "#this");
    if (message == null) dart.nullFailed(L6, 141, 14, "message");
    if (label == null) dart.nullFailed(L6, 141, 30, "label");
    if (secondarySpans == null) dart.nullFailed(L6, 141, 61, "secondarySpans");
    let color = opts && 'color' in opts ? opts.color : false;
    if (color == null) dart.nullFailed(L6, 142, 13, "color");
    let primaryColor = opts && 'primaryColor' in opts ? opts.primaryColor : null;
    let secondaryColor = opts && 'secondaryColor' in opts ? opts.secondaryColor : null;
  ...
  span['SourceSpanExtension|highlightMultiple'] = function SourceSpanExtension$124highlightMultiple($this, label, secondarySpans, opts) {
    if ($this == null) dart.nullFailed(L6, 176, 10, "#this");
    if (label == null) dart.nullFailed(L6, 176, 35, "label");
    if (secondarySpans == null) dart.nullFailed(L6, 176, 66, "secondarySpans");
    let color = opts && 'color' in opts ? opts.color : false;
    if (color == null) dart.nullFailed(L6, 177, 17, "color");
    let primaryColor = opts && 'primaryColor' in opts ? opts.primaryColor : null;
    let secondaryColor = opts && 'secondaryColor' in opts ? opts.secondaryColor : null;
  ...
  span['SourceSpanExtension|subspan'] = function SourceSpanExtension$124subspan($this, start, end = null) {
    if ($this == null) dart.nullFailed(L6, 186, 14, "#this");
    if (start == null) dart.nullFailed(L6, 186, 26, "start");
    ...
    function consumeCodePoint(i) {
      if (i == null) dart.nullFailed(L6, 197, 31, "i");
  ...
  location.SourceLocation = class SourceLocation extends core.Object {
    ...
    distance(other) {
      if (other == null) dart.nullFailed(L11, 62, 31, "other");
      if (!dart.equals(this.sourceUrl, other.sourceUrl)) {
        dart.throw(new core.ArgumentError.new("Source URLs \"" + dart.str(this.sourceUrl) + "\" and " + "\"" + dart.str(other.sourceUrl) + "\" don't match."));
      }
      return (dart.notNull(this.offset) - dart.notNull(other.offset))[$abs]();
    ...
    compareTo(other) {
      location.SourceLocation.as(other);
      if (other == null) dart.nullFailed(L11, 77, 32, "other");
      if (!dart.equals(this.sourceUrl, other.sourceUrl)) {
        dart.throw(new core.ArgumentError.new("Source URLs \"" + dart.str(this.sourceUrl) + "\" and " + "\"" + dart.str(other.sourceUrl) + "\" don't match."));
      }
      return dart.notNull(this.offset) - dart.notNull(other.offset);
  ...
  (location.SourceLocation.new = function(offset, opts) {
    let t7, t7$;
    if (offset == null) dart.nullFailed(L11, 45, 23, "offset");
    let sourceUrl = opts && 'sourceUrl' in opts ? opts.sourceUrl : null;
    let line = opts && 'line' in opts ? opts.line : null;
    let column = opts && 'column' in opts ? opts.column : null;
    this[offset$] = offset;
    this[sourceUrl$] = typeof sourceUrl == 'string' ? core.Uri.parse(sourceUrl) : UriN().as(sourceUrl);
  ...
  dart.setLibraryUri(location.SourceLocation, L12);
  ...
  (location.SourceLocationBase.new = function(offset, opts) {
    if (offset == null) dart.nullFailed(L11, 101, 26, "offset");
    let sourceUrl = opts && 'sourceUrl' in opts ? opts.sourceUrl : null;
    let line = opts && 'line' in opts ? opts.line : null;
    let column = opts && 'column' in opts ? opts.column : null;
  ...
  dart.setLibraryUri(location.SourceLocationBase, L12);
  ...
  file.SourceFile = class SourceFile extends core.Object {
    ...
    span(start, end = null) {
      if (start == null) dart.nullFailed(L13, 90, 21, "start");
      end == null ? end = this.length : null;
      return new file._FileSpan.new(this, start, end);
    }
    location(offset) {
      if (offset == null) dart.nullFailed(L13, 96, 29, "offset");
      return new file.FileLocation.__(this, offset);
    }
    getLine(offset) {
      if (offset == null) dart.nullFailed(L13, 99, 19, "offset");
    ...
    [_isNearCachedLine](offset) {
      if (offset == null) dart.nullFailed(L13, 120, 30, "offset");
    ...
    [_binarySearch](offset) {
      if (offset == null) dart.nullFailed(L13, 146, 25, "offset");
      let min = 0;
    ...
    getColumn(offset, opts) {
      if (offset == null) dart.nullFailed(L13, 165, 21, "offset");
      let line = opts && 'line' in opts ? opts.line : null;
      if (dart.notNull(offset) < 0) {
        dart.throw(new core.RangeError.new("Offset may not be negative, was " + dart.str(offset) + "."));
      } else if (dart.notNull(offset) > dart.notNull(this.length)) {
    ...
    getOffset(line, column = null) {
      if (line == null) dart.nullFailed(L13, 193, 21, "line");
  ...
  (file.SourceFile.fromString = function(text, opts) {
    if (text == null) dart.nullFailed(L13, 61, 32, "text");
    let url = opts && 'url' in opts ? opts.url : null;
    file.SourceFile.decoded.call(this, text[$codeUnits], {url: url});
  }).prototype = file.SourceFile.prototype;
  (file.SourceFile.decoded = function(decodedChars, opts) {
    if (decodedChars == null) dart.nullFailed(L13, 73, 36, "decodedChars");
    let url = opts && 'url' in opts ? opts.url : null;
    this[_lineStarts] = JSArrayOfint().of([0]);
    this[_cachedLine] = null;
    this[url$] = typeof url == 'string' ? core.Uri.parse(url) : UriN().as(url);
  ...
  dart.setLibraryUri(file.SourceFile, L14);
  ...
  (file.FileLocation.__ = function(file, offset) {
    if (file == null) dart.nullFailed(L13, 243, 23, "file");
    if (offset == null) dart.nullFailed(L13, 243, 34, "offset");
    this[file$] = file;
  ...
  dart.setLibraryUri(file.FileLocation, L14);
  ...
  dart.setLibraryUri(file.FileSpan, L14);
  ...
  file._FileSpan = class _FileSpan extends span_mixin.SourceSpanMixin {
    ...
    compareTo(other) {
      span.SourceSpan.as(other);
      if (other == null) dart.nullFailed(L13, 363, 28, "other");
    ...
    union(other) {
      if (other == null) dart.nullFailed(L13, 371, 31, "other");
    ...
    expand(other) {
      if (other == null) dart.nullFailed(L13, 410, 28, "other");
      if (!dart.equals(this.sourceUrl, other.sourceUrl)) {
        dart.throw(new core.ArgumentError.new("Source URLs \"" + dart.str(this.sourceUrl) + "\" and " + " \"" + dart.str(other.sourceUrl) + "\" don't match."));
      }
      if (file._FileSpan.is(other)) {
    ...
    subspan(start, end = null) {
      if (start == null) dart.nullFailed(L13, 428, 24, "start");
      core.RangeError.checkValidRange(start, end, this.length);
      if (start === 0 && (end == null || end == this.length)) return this;
  ...
  (file._FileSpan.new = function(file, _start, _end) {
    if (file == null) dart.nullFailed(L13, 351, 18, "file");
    if (_start == null) dart.nullFailed(L13, 351, 29, "_start");
    if (_end == null) dart.nullFailed(L13, 351, 42, "_end");
    this.file = file;
    this[_start$] = _start;
    this[_end$] = _end;
  ...
  dart.setLibraryUri(file._FileSpan, L14);
  ...
  file['FileSpanExtension|subspan'] = function FileSpanExtension$124subspan($this, start, end = null) {
    if ($this == null) dart.nullFailed(L13, 439, 12, "#this");
    if (start == null) dart.nullFailed(L13, 439, 24, "start");
    core.RangeError.checkValidRange(start, end, $this.length);
    if (start === 0 && (end == null || end == $this.length)) return $this;
