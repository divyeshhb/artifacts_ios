define(['dart_sdk', 'packages/flutter/src/painting/borders.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/painting/circle_border.dart', 'packages/flutter/src/painting/rounded_rectangle_border.dart', 'packages/flutter/src/painting/border_radius.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__painting__stadium_border_dart(dart_sdk, packages__flutter__src__painting__borders$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__painting__circle_border$46dart, packages__flutter__src__painting__rounded_rectangle_border$46dart, packages__flutter__src__painting__border_radius$46dart, packages__flutter__src__foundation__object$46dart) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/painting/stadium_border.dart";
  dart.defineLazy(CT, {
    get C1() {
  ...
  stadium_border.StadiumBorder = class StadiumBorder extends borders.OutlinedBorder {
    ...
    scale(t) {
      if (t == null) dart.nullFailed(L0, 40, 28, "t");
      return new stadium_border.StadiumBorder.new({side: this.side.scale(t)});
    }
    lerpFrom(a, t) {
      if (t == null) dart.nullFailed(L0, 43, 48, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 44, 12, "t != null");
    ...
    lerpTo(b, t) {
      if (t == null) dart.nullFailed(L0, 64, 46, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 65, 12, "t != null");
    ...
    getInnerPath(rect, opts) {
      let t0;
      if (rect == null) dart.nullFailed(L0, 90, 26, "rect");
    ...
    getOuterPath(rect, opts) {
      let t0;
      if (rect == null) dart.nullFailed(L0, 97, 26, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      let radius = new ui.Radius.circular(dart.notNull(rect.shortestSide) / 2.0);
      t0 = ui.Path.new();
      return (() => {
    ...
    paint(canvas, rect, opts) {
      if (canvas == null) dart.nullFailed(L0, 104, 21, "canvas");
      if (rect == null) dart.nullFailed(L0, 104, 34, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
  ...
  (stadium_border.StadiumBorder.new = function(opts) {
    ...
    if (side == null) dart.nullFailed(L0, 32, 36, "side");
    if (!(side != null)) dart.assertFailed(null, L0, 32, 71, "side != null");
  ...
  stadium_border._StadiumToCircleBorder = class _StadiumToCircleBorder extends borders.OutlinedBorder {
    ...
    scale(t) {
      if (t == null) dart.nullFailed(L0, 151, 28, "t");
      return new stadium_border._StadiumToCircleBorder.new({side: this.side.scale(t), circleness: t});
    }
    lerpFrom(a, t) {
      if (t == null) dart.nullFailed(L0, 159, 48, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 160, 12, "t != null");
    ...
    lerpTo(b, t) {
      if (t == null) dart.nullFailed(L0, 183, 46, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 184, 12, "t != null");
    ...
    [_adjustRect](rect) {
      if (rect == null) dart.nullFailed(L0, 206, 25, "rect");
    ...
    [_adjustBorderRadius](rect) {
      if (rect == null) dart.nullFailed(L0, 228, 41, "rect");
      return new border_radius.BorderRadius.circular(dart.notNull(rect.shortestSide) / 2.0);
    }
    getInnerPath(rect, opts) {
      let t0;
      if (rect == null) dart.nullFailed(L0, 233, 26, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t0 = ui.Path.new();
      return (() => {
    ...
    getOuterPath(rect, opts) {
      let t0;
      if (rect == null) dart.nullFailed(L0, 239, 26, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t0 = ui.Path.new();
      return (() => {
    ...
    paint(canvas, rect, opts) {
      let t0;
      if (canvas == null) dart.nullFailed(L0, 253, 21, "canvas");
      if (rect == null) dart.nullFailed(L0, 253, 34, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      switch (this.side.style) {
        case C1 || CT.C1:
        {
  ...
  (stadium_border._StadiumToCircleBorder.new = function(opts) {
    let side = opts && 'side' in opts ? opts.side : C0 || CT.C0;
    if (side == null) dart.nullFailed(L0, 137, 16, "side");
    let circleness = opts && 'circleness' in opts ? opts.circleness : 0;
    if (circleness == null) dart.nullFailed(L0, 138, 10, "circleness");
    this[circleness$] = circleness;
    if (!(side != null)) dart.assertFailed(null, L0, 139, 15, "side != null");
    if (!(circleness != null)) dart.assertFailed(null, L0, 140, 15, "circleness != null");
  ...
  stadium_border._StadiumToRoundedRectangleBorder = class _StadiumToRoundedRectangleBorder extends borders.OutlinedBorder {
    ...
    scale(t) {
      if (t == null) dart.nullFailed(L0, 311, 28, "t");
    ...
    lerpFrom(a, t) {
      if (t == null) dart.nullFailed(L0, 320, 48, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 321, 12, "t != null");
      if (stadium_border.StadiumBorder.is(a)) {
    ...
    lerpTo(b, t) {
      if (t == null) dart.nullFailed(L0, 347, 46, "t");
      if (!(t != null)) dart.assertFailed(null, L0, 348, 12, "t != null");
      if (stadium_border.StadiumBorder.is(b)) {
    ...
    [_adjustBorderRadius](rect) {
      if (rect == null) dart.nullFailed(L0, 373, 41, "rect");
    ...
    getOuterPath(rect, opts) {
      let t0;
      if (rect == null) dart.nullFailed(L0, 388, 26, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t0 = ui.Path.new();
      return (() => {
    ...
    paint(canvas, rect, opts) {
      let t0;
      if (canvas == null) dart.nullFailed(L0, 403, 21, "canvas");
      if (rect == null) dart.nullFailed(L0, 403, 34, "rect");
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      switch (this.side.style) {
        case C1 || CT.C1:
        {
  ...
  (stadium_border._StadiumToRoundedRectangleBorder.new = function(opts) {
    let side = opts && 'side' in opts ? opts.side : C0 || CT.C0;
    if (side == null) dart.nullFailed(L0, 293, 16, "side");
    let borderRadius = opts && 'borderRadius' in opts ? opts.borderRadius : C4 || CT.C4;
    if (borderRadius == null) dart.nullFailed(L0, 294, 10, "borderRadius");
    let rectness = opts && 'rectness' in opts ? opts.rectness : 0;
    if (rectness == null) dart.nullFailed(L0, 295, 10, "rectness");
    this[borderRadius$] = borderRadius;
    this[rectness$] = rectness;
    if (!(side != null)) dart.assertFailed(null, L0, 296, 15, "side != null");
    if (!(borderRadius != null)) dart.assertFailed(null, L0, 297, 15, "borderRadius != null");
    if (!(rectness != null)) dart.assertFailed(null, L0, 298, 15, "rectness != null");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["stadium_border.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;A