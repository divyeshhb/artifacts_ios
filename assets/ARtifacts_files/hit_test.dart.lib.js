define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart', 'packages/vector_math/vector_math_64.dart'], (function load__packages__flutter__src__gestures__hit_test_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart, packages__vector_math__vector_math_64$46dart) {
  ...
  var JSArrayOfHitTestEntry = () => (JSArrayOfHitTestEntry = dart.constFn(_interceptors.JSArray$(hit_test.HitTestEntry)))();
  var JSArrayOfMatrix4 = () => (JSArrayOfMatrix4 = dart.constFn(_interceptors.JSArray$(vector_math_64.Matrix4)))();
  var JSArrayOf_TransformPart = () => (JSArrayOf_TransformPart = dart.constFn(_interceptors.JSArray$(hit_test._TransformPart)))();
  var doubleTobool = () => (doubleTobool = dart.constFn(dart.fnType(core.bool, [core.double])))();
  var VoidTobool = () => (VoidTobool = dart.constFn(dart.fnType(core.bool, [])))();
  const CT = Object.create(null);
  var L0 = "package:flutter/src/gestures/hit_test.dart";
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/gestures/hit_test.dart";
  ...
  dart.setLibraryUri(hit_test.HitTestable, L0);
  ...
  dart.setLibraryUri(hit_test.HitTestDispatcher, L0);
  ...
  dart.setLibraryUri(hit_test.HitTestTarget, L0);
  ...
  (hit_test.HitTestEntry.new = function(target) {
    if (target == null) dart.nullFailed(L1, 50, 21, "target");
  ...
  dart.setLibraryUri(hit_test.HitTestEntry, L0);
  ...
  dart.setLibraryUri(hit_test._TransformPart, L0);
  ...
  dart.setLibraryUri(hit_test._MatrixTransformPart, L0);
  ...
  hit_test._OffsetTransformPart = class _OffsetTransformPart extends hit_test._TransformPart {
    ...
    multiply(rhs) {
      let t0;
      if (rhs == null) dart.nullFailed(L1, 103, 28, "rhs");
      t0 = rhs.clone();
      return (() => {
  ...
  (hit_test._OffsetTransformPart.new = function(offset) {
    if (offset == null) dart.nullFailed(L1, 98, 35, "offset");
    this[offset$] = offset;
  ...
  dart.setLibraryUri(hit_test._OffsetTransformPart, L0);
  ...
  hit_test.HitTestResult = class HitTestResult extends core.Object {
    ...
    popTransform() {
      ...
      if (!dart.test(this[_transforms][$isNotEmpty])) dart.assertFailed(null, L1, 274, 12, "_transforms.isNotEmpty");
    }
    [_debugVectorMoreOrLessEquals](a, b, opts) {
      if (a == null) dart.nullFailed(L1, 277, 45, "a");
      if (b == null) dart.nullFailed(L1, 277, 56, "b");
      let epsilon = opts && 'epsilon' in opts ? opts.epsilon : 1e-10;
      if (epsilon == null) dart.nullFailed(L1, 277, 68, "epsilon");
      let result = true;
      if (!dart.test(dart.fn(() => {
        let difference = a['-'](b);
        result = difference.storage[$every](dart.fn(component => {
          if (component == null) dart.nullFailed(L1, 281, 49, "component");
          return component[$abs]() < dart.notNull(epsilon);
        }, doubleTobool()));
        return true;
      }, VoidTobool())())) dart.assertFailed(null, L1, 279, 12, "() {\n      final Vector4 difference = a - b;\n      result = difference.storage.every((double component) => component.abs() < epsilon);\n      return true;\n    }()");
      return result;
    }
    toString() {
  ...
  (hit_test.HitTestResult.new = function() {
    ...
    this[_transforms] = JSArrayOfMatrix4().of([vector_math_64.Matrix4.identity()]);
    this[_localTransforms] = JSArrayOf_TransformPart().of([]);
    ;
  }).prototype = hit_test.HitTestResult.prototype;
  (hit_test.HitTestResult.wrap = function(result) {
    if (result == null) dart.nullFailed(L1, 122, 36, "result");
  ...
  dart.setLibraryUri(hit_test.HitTestResult, L0);
