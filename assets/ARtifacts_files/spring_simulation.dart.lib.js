define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/physics/tolerance.dart', 'packages/flutter/src/physics/utils.dart', 'packages/flutter/src/physics/simulation.dart'], (function load__packages__flutter__src__physics__spring_simulation_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__physics__tolerance$46dart, packages__flutter__src__physics__utils$46dart, packages__flutter__src__physics__simulation$46dart) {
  ...
  var L1 = "package:flutter/src/physics/spring_simulation.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/physics/spring_simulation.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  (spring_simulation.SpringDescription.new = function(opts) {
    ...
    if (mass == null) dart.nullFailed(L0, 21, 19, "mass");
    let stiffness = opts && 'stiffness' in opts ? opts.stiffness : null;
    if (stiffness == null) dart.nullFailed(L0, 22, 19, "stiffness");
    let damping = opts && 'damping' in opts ? opts.damping : null;
    if (damping == null) dart.nullFailed(L0, 23, 19, "damping");
    this[mass$] = mass;
  ...
  (spring_simulation.SpringDescription.withDampingRatio = function(opts) {
    let mass = opts && 'mass' in opts ? opts.mass : null;
    if (mass == null) dart.nullFailed(L0, 34, 19, "mass");
    let stiffness = opts && 'stiffness' in opts ? opts.stiffness : null;
    if (stiffness == null) dart.nullFailed(L0, 35, 19, "stiffness");
    let ratio = opts && 'ratio' in opts ? opts.ratio : 1;
    if (ratio == null) dart.nullFailed(L0, 36, 12, "ratio");
    this[mass$] = mass;
    this[stiffness$] = stiffness;
  ...
  dart.setLibraryUri(spring_simulation.SpringDescription, L1);
  ...
  (spring_simulation.SpringType.new = function(index, _name) {
    if (index == null) dart.nullFailed(L0, 66, 6, "index");
    if (_name == null) dart.nullFailed(L0, 66, 6, "_name");
    this.index = index;
    this[_name$] = _name;
    ;
  ...
  dart.setLibraryUri(spring_simulation.SpringType, L1);
  ...
  spring_simulation.SpringSimulation = class SpringSimulation extends simulation.Simulation {
    ...
    x(time) {
      if (time == null) dart.nullFailed(L0, 112, 19, "time");
      return dart.notNull(this[_endPosition]) + dart.notNull(this[_solution].x(time));
    }
    dx(time) {
      if (time == null) dart.nullFailed(L0, 115, 20, "time");
      return this[_solution].dx(time);
    }
    isDone(time) {
      if (time == null) dart.nullFailed(L0, 118, 22, "time");
  ...
  (spring_simulation.SpringSimulation.new = function(spring, start, end, velocity, opts) {
    if (spring == null) dart.nullFailed(L0, 93, 23, "spring");
    if (start == null) dart.nullFailed(L0, 94, 12, "start");
    if (end == null) dart.nullFailed(L0, 95, 12, "end");
    if (velocity == null) dart.nullFailed(L0, 96, 12, "velocity");
    let tolerance = opts && 'tolerance' in opts ? opts.tolerance : C4 || CT.C4;
    if (tolerance == null) dart.nullFailed(L0, 97, 15, "tolerance");
  ...
  dart.setLibraryUri(spring_simulation.SpringSimulation, L1);
  ...
  spring_simulation.ScrollSpringSimulation = class ScrollSpringSimulation extends spring_simulation.SpringSimulation {
    x(time) {
      if (time == null) dart.nullFailed(L0, 144, 19, "time");
  ...
  (spring_simulation.ScrollSpringSimulation.new = function(spring, start, end, velocity, opts) {
    if (spring == null) dart.nullFailed(L0, 136, 23, "spring");
    if (start == null) dart.nullFailed(L0, 137, 12, "start");
    if (end == null) dart.nullFailed(L0, 138, 12, "end");
    if (velocity == null) dart.nullFailed(L0, 139, 12, "velocity");
    let tolerance = opts && 'tolerance' in opts ? opts.tolerance : C4 || CT.C4;
    if (tolerance == null) dart.nullFailed(L0, 140, 15, "tolerance");
  ...
  dart.setLibraryUri(spring_simulation.ScrollSpringSimulation, L1);
  spring_simulation._SpringSolution = class _SpringSolution extends core.Object {
    static new(spring, initialPosition, initialVelocity) {
      if (spring == null) dart.nullFailed(L0, 152, 23, "spring");
      if (initialPosition == null) dart.nullFailed(L0, 153, 12, "initialPosition");
      if (initialVelocity == null) dart.nullFailed(L0, 154, 12, "initialVelocity");
      if (!(spring != null)) dart.assertFailed(null, L0, 156, 12, "spring != null");
      if (!(spring.mass != null)) dart.assertFailed(null, L0, 157, 12, "spring.mass != null");
      if (!(spring.stiffness != null)) dart.assertFailed(null, L0, 158, 12, "spring.stiffness != null");
      if (!(spring.damping != null)) dart.assertFailed(null, L0, 159, 12, "spring.damping != null");
      if (!(initialPosition != null)) dart.assertFailed(null, L0, 160, 12, "initialPosition != null");
      if (!(initialVelocity != null)) dart.assertFailed(null, L0, 161, 12, "initialVelocity != null");
  ...
  dart.setLibraryUri(spring_simulation._SpringSolution, L1);
  ...
  spring_simulation._CriticalSolution = class _CriticalSolution extends core.Object {
    static new(spring, distance, velocity) {
      if (spring == null) dart.nullFailed(L0, 177, 23, "spring");
      if (distance == null) dart.nullFailed(L0, 178, 12, "distance");
      if (velocity == null) dart.nullFailed(L0, 179, 12, "velocity");
    ...
    x(time) {
      if (time == null) dart.nullFailed(L0, 195, 19, "time");
    ...
    dx(time) {
      if (time == null) dart.nullFailed(L0, 200, 20, "time");
  ...
  (spring_simulation._CriticalSolution.withArgs = function(r, c1, c2) {
    if (r == null) dart.nullFailed(L0, 187, 37, "r");
    if (c1 == null) dart.nullFailed(L0, 187, 47, "c1");
    if (c2 == null) dart.nullFailed(L0, 187, 58, "c2");
    this[_r] = r;
    this[_c1] = c1;
    this[_c2] = c2;
    ;
  ...
  dart.setLibraryUri(spring_simulation._CriticalSolution, L1);
  ...
  spring_simulation._OverdampedSolution = class _OverdampedSolution extends core.Object {
    static new(spring, distance, velocity) {
      if (spring == null) dart.nullFailed(L0, 211, 23, "spring");
      if (distance == null) dart.nullFailed(L0, 212, 12, "distance");
      if (velocity == null) dart.nullFailed(L0, 213, 12, "velocity");
      let cmk = dart.notNull(spring.damping) * dart.notNull(spring.damping) - 4 * dart.notNull(spring.mass) * dart.notNull(spring.stiffness);
    ...
    x(time) {
      if (time == null) dart.nullFailed(L0, 232, 19, "time");
    ...
    dx(time) {
      if (time == null) dart.nullFailed(L0, 238, 20, "time");
  ...
  (spring_simulation._OverdampedSolution.withArgs = function(r1, r2, c1, c2) {
    if (r1 == null) dart.nullFailed(L0, 223, 39, "r1");
    if (r2 == null) dart.nullFailed(L0, 223, 50, "r2");
    if (c1 == null) dart.nullFailed(L0, 223, 61, "c1");
    if (c2 == null) dart.nullFailed(L0, 223, 72, "c2");
    this[_r1] = r1;
    this[_r2] = r2;
    this[_c1] = c1;
    this[_c2] = c2;
  ...
  dart.setLibraryUri(spring_simulation._OverdampedSolution, L1);
  ...
  spring_simulation._UnderdampedSolution = class _UnderdampedSolution extends core.Object {
    static new(spring, distance, velocity) {
      if (spring == null) dart.nullFailed(L0, 249, 23, "spring");
      if (distance == null) dart.nullFailed(L0, 250, 12, "distance");
      if (velocity == null) dart.nullFailed(L0, 251, 12, "velocity");
    ...
    x(time) {
      if (time == null) dart.nullFailed(L0, 270, 19, "time");
    ...
    dx(time) {
      if (time == null) dart.nullFailed(L0, 276, 20, "time");
      let power = math.pow(2.718281828459045, dart.notNull(this[_r]) * dart.notNull(time));
  ...
  (spring_simulation._UnderdampedSolution.withArgs = function(w, r, c1, c2) {
    if (w == null) dart.nullFailed(L0, 261, 40, "w");
    if (r == null) dart.nullFailed(L0, 261, 50, "r");
    if (c1 == null) dart.nullFailed(L0, 261, 60, "c1");
    if (c2 == null) dart.nullFailed(L0, 261, 71, "c2");
    this[_w] = w;
    this[_r] = r;
    this[_c1] = c1;
    this[_c2] = c2;
  ...
  dart.setLibraryUri(spring_simulation._UnderdampedSolution, L1);
