define(['dart_sdk', 'packages/flutter/src/painting/borders.dart'], (function load__packages__flutter__src__painting__notched_shapes_dart(dart_sdk, packages__flutter__src__painting__borders$46dart) {
  ...
  var ListOfOffsetN = () => (ListOfOffsetN = dart.constFn(core.List$(OffsetN())))();
  const CT = Object.create(null);
  var L0 = "package:flutter/src/painting/notched_shapes.dart";
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/painting/notched_shapes.dart";
  ...
  dart.setLibraryUri(notched_shapes.NotchedShape, L0);
  notched_shapes.CircularNotchedRectangle = class CircularNotchedRectangle extends notched_shapes.NotchedShape {
    getOuterPath(host, guest) {
      let t0, t0$;
      if (host == null) dart.nullFailed(L1, 59, 26, "host");
      ...
      let p = ListOfOffsetN().filled(6, null, {growable: false});
  ...
  dart.setLibraryUri(notched_shapes.CircularNotchedRectangle, L0);
  ...
  notched_shapes.AutomaticNotchedShape = class AutomaticNotchedShape extends notched_shapes.NotchedShape {
    ...
    getOuterPath(hostRect, guestRect) {
      if (hostRect == null) dart.nullFailed(L1, 154, 26, "hostRect");
  ...
  (notched_shapes.AutomaticNotchedShape.new = function(host, guest = null) {
    if (host == null) dart.nullFailed(L1, 136, 36, "host");
    this[host$] = host;
    this[guest$] = guest;
  ...
  dart.setLibraryUri(notched_shapes.AutomaticNotchedShape, L0);
