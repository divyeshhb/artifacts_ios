define(['dart_sdk'], (function load__packages__collection__src__comparators_dart(dart_sdk) {
  ...
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/.pub-cache/hosted/pub.dartlang.org/collection-1.15.0-nullsafety.5/lib/src/comparators.dart";
  comparators.equalsIgnoreAsciiCase = function equalsIgnoreAsciiCase(a, b) {
    if (a == null) dart.nullFailed(L0, 27, 35, "a");
    if (b == null) dart.nullFailed(L0, 27, 45, "b");
  ...
  comparators.hashIgnoreAsciiCase = function hashIgnoreAsciiCase(string) {
    if (string == null) dart.nullFailed(L0, 50, 32, "string");
    let hash = 0;
  ...
  comparators.compareAsciiUpperCase = function compareAsciiUpperCase(a, b) {
    if (a == null) dart.nullFailed(L0, 85, 34, "a");
    if (b == null) dart.nullFailed(L0, 85, 44, "b");
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
  ...
  comparators.compareAsciiLowerCase = function compareAsciiLowerCase(a, b) {
    if (a == null) dart.nullFailed(L0, 122, 34, "a");
    if (b == null) dart.nullFailed(L0, 122, 44, "b");
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  comparators.compareNatural = function compareNatural(a, b) {
    if (a == null) dart.nullFailed(L0, 161, 27, "a");
    if (b == null) dart.nullFailed(L0, 161, 37, "b");
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
      let bChar = b[$codeUnitAt](i);
  ...
  comparators.compareAsciiLowerCaseNatural = function compareAsciiLowerCaseNatural(a, b) {
    if (a == null) dart.nullFailed(L0, 187, 41, "a");
    if (b == null) dart.nullFailed(L0, 187, 51, "b");
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  comparators.compareAsciiUpperCaseNatural = function compareAsciiUpperCaseNatural(a, b) {
    if (a == null) dart.nullFailed(L0, 224, 41, "a");
    if (b == null) dart.nullFailed(L0, 224, 51, "b");
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  comparators._compareNaturally = function _compareNaturally(a, b, index, aChar, bChar) {
    if (a == null) dart.nullFailed(L0, 258, 30, "a");
    if (b == null) dart.nullFailed(L0, 258, 40, "b");
    if (index == null) dart.nullFailed(L0, 258, 47, "index");
    if (aChar == null) dart.nullFailed(L0, 258, 58, "aChar");
    if (bChar == null) dart.nullFailed(L0, 258, 69, "bChar");
  ...
  comparators._compareNumerically = function _compareNumerically(a, b, aChar, bChar, index) {
    if (a == null) dart.nullFailed(L0, 283, 32, "a");
    if (b == null) dart.nullFailed(L0, 283, 42, "b");
    if (aChar == null) dart.nullFailed(L0, 283, 49, "aChar");
    if (bChar == null) dart.nullFailed(L0, 283, 60, "bChar");
    if (index == null) dart.nullFailed(L0, 283, 71, "index");
  ...
  comparators._compareDigitCount = function _compareDigitCount(a, b, i, j) {
    if (a == null) dart.nullFailed(L0, 360, 31, "a");
    if (b == null) dart.nullFailed(L0, 360, 41, "b");
    if (i == null) dart.nullFailed(L0, 360, 48, "i");
    if (j == null) dart.nullFailed(L0, 360, 55, "j");
  ...
  comparators._isDigit = function _isDigit(charCode) {
    if (charCode == null) dart.nullFailed(L0, 380, 19, "charCode");
    return (dart.notNull(charCode) ^ 48) >>> 0 <= 9;
  };
  comparators._isNonZeroNumberSuffix = function _isNonZeroNumberSuffix(string, index) {
    if (string == null) dart.nullFailed(L0, 387, 36, "string");
    if (index == null) dart.nullFailed(L0, 387, 48, "index");
