define(['dart_sdk', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/change_notifier.dart'], (function load__packages__flutter__src__rendering__custom_layout_dart(dart_sdk, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__change_notifier$46dart) {
  ...
  var L1 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/rendering/custom_layout.dart";
  ...
  custom_layout.MultiChildLayoutDelegate = class MultiChildLayoutDelegate extends core.Object {
    hasChild(childId) {
      if (childId == null) dart.nullFailed(L1, 133, 24, "childId");
      return dart.nullCheck(this[_idToChild])[$_get](childId) != null;
    }
    layoutChild(childId, constraints) {
      if (childId == null) dart.nullFailed(L1, 141, 27, "childId");
      if (constraints == null) dart.nullFailed(L1, 141, 51, "constraints");
      ...
      if (!dart.test(dart.fn(() => {
        ...
        try {
          if (!dart.test(constraints.debugAssertIsValid({isAppliedConstraint: true}))) dart.assertFailed(null, L1, 157, 16, "constraints.debugAssertIsValid(isAppliedConstraint: true)");
        } catch (e) {
    ...
    [_debugDescribeChild](child) {
      if (child == null) dart.nullFailed(L1, 204, 49, "child");
    ...
    [_callPerformLayout](size, firstChild) {
      if (size == null) dart.nullFailed(L1, 209, 32, "size");
        ...
        while (child != null) {
          ...
          if (!dart.test(dart.fn(() => {
            if (childParentData.id == null) {
              dart.throw(new assertions.FlutterError.fromParts(JSArrayOfDiagnosticsNode().of([new assertions.ErrorSummary.new("Every child of a RenderCustomMultiChildLayoutBox must have an ID in its parent data."), dart.nullCheck(child).describeForError("The following child has no ID")])));
            }
            return true;
          }, VoidTobool())())) dart.assertFailed(null, L1, 227, 16, "() {\n          if (childParentData.id == null) {\n            throw FlutterError.fromParts(<DiagnosticsNode>[\n              ErrorSummary('Every child of a RenderCustomMultiChildLayoutBox must have an ID in its parent data.'),\n              child!.describeForError('The following child has no ID'),\n            ]);\n          }\n          return true;\n        }()");
          ...
          if (!dart.test(dart.fn(() => {
            ...
            return true;
          }, VoidTobool())())) dart.assertFailed(null, L1, 237, 16, "() {\n          _debugChildrenNeedingLayout!.add(child!);\n          return true;\n        }()");
  ...
  custom_layout.RenderCustomMultiChildLayoutBox = class RenderCustomMultiChildLayoutBox extends RenderBox_RenderBoxContainerDefaultsMixin$36 {
    setupParentData(child) {
      ...
      if (child == null) dart.nullFailed(L1, 324, 34, "child");
    ...
    set delegate(newDelegate) {
      let t1, t1$;
      if (newDelegate == null) dart.nullFailed(L1, 332, 41, "newDelegate");
      if (!(newDelegate != null)) dart.assertFailed(null, L1, 333, 12, "newDelegate != null");
    ...
    attach(owner) {
      ...
      if (owner == null) dart.nullFailed(L1, 347, 29, "owner");
      super.attach(owner);
    ...
    [_getSize](constraints) {
      if (constraints == null) dart.nullFailed(L1, 358, 32, "constraints");
      if (!dart.test(constraints.debugAssertIsValid())) dart.assertFailed(null, L1, 359, 12, "constraints.debugAssertIsValid()");
      return constraints.constrain(this[_delegate].getSize(constraints));
    }
    computeMinIntrinsicWidth(height) {
      if (height == null) dart.nullFailed(L1, 368, 42, "height");
      let width = this[_getSize](new box.BoxConstraints.tightForFinite({height: height})).width;
      if (width[$isFinite]) return width;
      return 0.0;
    }
    computeMaxIntrinsicWidth(height) {
      if (height == null) dart.nullFailed(L1, 376, 42, "height");
      let width = this[_getSize](new box.BoxConstraints.tightForFinite({height: height})).width;
      if (width[$isFinite]) return width;
      return 0.0;
    }
    computeMinIntrinsicHeight(width) {
      if (width == null) dart.nullFailed(L1, 384, 43, "width");
      let height = this[_getSize](new box.BoxConstraints.tightForFinite({width: width})).height;
      if (height[$isFinite]) return height;
      return 0.0;
    }
    computeMaxIntrinsicHeight(width) {
      if (width == null) dart.nullFailed(L1, 392, 43, "width");
      let height = this[_getSize](new box.BoxConstraints.tightForFinite({width: width})).height;
      if (height[$isFinite]) return height;
      return 0.0;
    }
    computeDryLayout(constraints) {
      if (constraints == null) dart.nullFailed(L1, 400, 40, "constraints");
    ...
    paint(context, offset) {
      if (context == null) dart.nullFailed(L1, 411, 30, "context");
      if (offset == null) dart.nullFailed(L1, 411, 46, "offset");
      this.defaultPaint(context, offset);
    }
    hitTestChildren(result, opts) {
      if (result == null) dart.nullFailed(L1, 416, 41, "result");
      let position = opts && 'position' in opts ? opts.position : null;
      if (position == null) dart.nullFailed(L1, 416, 67, "position");
  ...
  (custom_layout.RenderCustomMultiChildLayoutBox.new = function(opts) {
    ...
    if (delegate == null) dart.nullFailed(L1, 317, 39, "delegate");
    if (!(delegate != null)) dart.assertFailed(null, L1, 318, 15, "delegate != null");
