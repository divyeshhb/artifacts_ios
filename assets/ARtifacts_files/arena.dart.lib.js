define(['dart_sdk', 'packages/flutter/src/gestures/debug.dart', 'packages/flutter/src/foundation/print.dart'], (function load__packages__flutter__src__gestures__arena_dart(dart_sdk, packages__flutter__src__gestures__debug$46dart, packages__flutter__src__foundation__print$46dart) {
  ...
  var GestureArenaMemberToString = () => (GestureArenaMemberToString = dart.constFn(dart.fnType(core.String, [arena.GestureArenaMember])))();
  var IdentityMapOfint$_GestureArena = () => (IdentityMapOfint$_GestureArena = dart.constFn(_js_helper.IdentityMap$(core.int, arena._GestureArena)))();
  var VoidTo_GestureArena = () => (VoidTo_GestureArena = dart.constFn(dart.fnType(arena._GestureArena, [])))();
  var VoidTovoid = () => (VoidTovoid = dart.constFn(dart.fnType(dart.void, [])))();
  var VoidTobool = () => (VoidTobool = dart.constFn(dart.fnType(core.bool, [])))();
  const CT = Object.create(null);
  var L1 = "package:flutter/src/gestures/arena.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/gestures/arena.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  dart.setLibraryUri(arena.GestureDisposition, L1);
  ...
  dart.setLibraryUri(arena.GestureArenaMember, L1);
  ...
  arena.GestureArenaEntry = class GestureArenaEntry extends core.Object {
    resolve(disposition) {
      if (disposition == null) dart.nullFailed(L0, 52, 35, "disposition");
      this[_arena$][_resolve](this[_pointer$], this[_member$], disposition);
    }
  };
  (arena.GestureArenaEntry.__ = function(_arena, _pointer, _member) {
    if (_arena == null) dart.nullFailed(L0, 42, 28, "_arena");
    if (_pointer == null) dart.nullFailed(L0, 42, 41, "_pointer");
    if (_member == null) dart.nullFailed(L0, 42, 56, "_member");
    this[_arena$] = _arena;
  ...
  dart.setLibraryUri(arena.GestureArenaEntry, L1);
  ...
  arena._GestureArena = class _GestureArena extends core.Object {
    add(member) {
      if (member == null) dart.nullFailed(L0, 69, 31, "member");
      if (!dart.test(this.isOpen)) dart.assertFailed(null, L0, 70, 12, "isOpen");
    ...
    toString() {
      ...
      if (dart.test(this.members[$isEmpty])) {
        ...
        buffer.write(this.members[$map](core.String, dart.fn(member => {
          if (member == null) dart.nullFailed(L0, 80, 60, "member");
  ...
  dart.setLibraryUri(arena._GestureArena, L1);
  ...
  arena.GestureArenaManager = class GestureArenaManager extends core.Object {
    add(pointer, member) {
      if (pointer == null) dart.nullFailed(L0, 107, 29, "pointer");
      if (member == null) dart.nullFailed(L0, 107, 57, "member");
      let state = this[_arenas][$putIfAbsent](pointer, dart.fn(() => {
        if (!dart.test(this[_debugLogDiagnostic](pointer, "★ Opening new gesture arena."))) dart.assertFailed(null, L0, 109, 14, "_debugLogDiagnostic(pointer, '★ Opening new gesture arena.')");
        return new arena._GestureArena.new();
      }, VoidTo_GestureArena()));
      state.add(member);
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Adding: " + dart.str(member)))) dart.assertFailed(null, L0, 113, 12, "_debugLogDiagnostic(pointer, 'Adding: $member')");
      return new arena.GestureArenaEntry.__(this, pointer, member);
    }
    close(pointer) {
      if (pointer == null) dart.nullFailed(L0, 120, 18, "pointer");
      let state = this[_arenas][$_get](pointer);
      if (state == null) return;
      state.isOpen = false;
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Closing", state))) dart.assertFailed(null, L0, 125, 12, "_debugLogDiagnostic(pointer, 'Closing', state)");
      this[_tryToResolveArena](pointer, state);
    }
    sweep(pointer) {
      if (pointer == null) dart.nullFailed(L0, 142, 18, "pointer");
      let state = this[_arenas][$_get](pointer);
      if (state == null) return;
      if (!!dart.test(state.isOpen)) dart.assertFailed(null, L0, 146, 12, "!state.isOpen");
      if (dart.test(state.isHeld)) {
        state.hasPendingSweep = true;
        if (!dart.test(this[_debugLogDiagnostic](pointer, "Delaying sweep", state))) dart.assertFailed(null, L0, 149, 14, "_debugLogDiagnostic(pointer, 'Delaying sweep', state)");
        return;
      }
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Sweeping", state))) dart.assertFailed(null, L0, 152, 12, "_debugLogDiagnostic(pointer, 'Sweeping', state)");
      this[_arenas][$remove](pointer);
      if (dart.test(state.members[$isNotEmpty])) {
        if (!dart.test(this[_debugLogDiagnostic](pointer, "Winner: " + dart.str(state.members[$first])))) dart.assertFailed(null, L0, 156, 14, "_debugLogDiagnostic(pointer, 'Winner: ${state.members.first}')");
    ...
    hold(pointer) {
      if (pointer == null) dart.nullFailed(L0, 176, 17, "pointer");
      let state = this[_arenas][$_get](pointer);
      if (state == null) return;
      state.isHeld = true;
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Holding", state))) dart.assertFailed(null, L0, 181, 12, "_debugLogDiagnostic(pointer, 'Holding', state)");
    }
    release(pointer) {
      if (pointer == null) dart.nullFailed(L0, 193, 20, "pointer");
      let state = this[_arenas][$_get](pointer);
      if (state == null) return;
      state.isHeld = false;
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Releasing", state))) dart.assertFailed(null, L0, 198, 12, "_debugLogDiagnostic(pointer, 'Releasing', state)");
      if (dart.test(state.hasPendingSweep)) this.sweep(pointer);
    }
    [_resolve](pointer, member, disposition) {
      let t0;
      if (pointer == null) dart.nullFailed(L0, 206, 21, "pointer");
      if (member == null) dart.nullFailed(L0, 206, 49, "member");
      if (disposition == null) dart.nullFailed(L0, 206, 76, "disposition");
      let state = this[_arenas][$_get](pointer);
      if (state == null) return;
      if (!dart.test(this[_debugLogDiagnostic](pointer, (dart.equals(disposition, arena.GestureDisposition.accepted) ? "Accepting" : "Rejecting") + ": " + dart.str(member)))) dart.assertFailed(null, L0, 210, 12, "_debugLogDiagnostic(pointer, '${ disposition == GestureDisposition.accepted ? \"Accepting\" : \"Rejecting\" }: $member')");
      if (!dart.test(state.members[$contains](member))) dart.assertFailed(null, L0, 211, 12, "state.members.contains(member)");
      if (dart.equals(disposition, arena.GestureDisposition.rejected)) {
        ...
        if (!dart.equals(disposition, arena.GestureDisposition.accepted)) dart.assertFailed(null, L0, 218, 14, "disposition == GestureDisposition.accepted");
        if (dart.test(state.isOpen)) {
          t0 = state;
          t0.eagerWinner == null ? t0.eagerWinner = member : null;
        } else {
          if (!dart.test(this[_debugLogDiagnostic](pointer, "Self-declared winner: " + dart.str(member)))) dart.assertFailed(null, L0, 222, 16, "_debugLogDiagnostic(pointer, 'Self-declared winner: $member')");
          this[_resolveInFavorOf](pointer, state, member);
        }
      }
    }
    [_tryToResolveArena](pointer, state) {
      if (pointer == null) dart.nullFailed(L0, 228, 31, "pointer");
      if (state == null) dart.nullFailed(L0, 228, 54, "state");
      if (!dart.equals(this[_arenas][$_get](pointer), state)) dart.assertFailed(null, L0, 229, 12, "_arenas[pointer] == state");
      if (!!dart.test(state.isOpen)) dart.assertFailed(null, L0, 230, 12, "!state.isOpen");
      if (state.members[$length] === 1) {
        ...
        this[_arenas][$remove](pointer);
        if (!dart.test(this[_debugLogDiagnostic](pointer, "Arena empty."))) dart.assertFailed(null, L0, 235, 14, "_debugLogDiagnostic(pointer, 'Arena empty.')");
      } else if (state.eagerWinner != null) {
        if (!dart.test(this[_debugLogDiagnostic](pointer, "Eager winner: " + dart.str(state.eagerWinner)))) dart.assertFailed(null, L0, 237, 14, "_debugLogDiagnostic(pointer, 'Eager winner: ${state.eagerWinner}')");
        this[_resolveInFavorOf](pointer, state, dart.nullCheck(state.eagerWinner));
      }
    }
    [_resolveByDefault](pointer, state) {
      if (pointer == null) dart.nullFailed(L0, 242, 30, "pointer");
      if (state == null) dart.nullFailed(L0, 242, 53, "state");
      if (!dart.test(this[_arenas][$containsKey](pointer))) return;
      if (!dart.equals(this[_arenas][$_get](pointer), state)) dart.assertFailed(null, L0, 245, 12, "_arenas[pointer] == state");
      if (!!dart.test(state.isOpen)) dart.assertFailed(null, L0, 246, 12, "!state.isOpen");
      let members = state.members;
      if (!(members[$length] === 1)) dart.assertFailed(null, L0, 248, 12, "members.length == 1");
      this[_arenas][$remove](pointer);
      if (!dart.test(this[_debugLogDiagnostic](pointer, "Default winner: " + dart.str(state.members[$first])))) dart.assertFailed(null, L0, 250, 12, "_debugLogDiagnostic(pointer, 'Default winner: ${state.members.first}')");
      state.members[$first].acceptGesture(pointer);
    }
    [_resolveInFavorOf](pointer, state, member) {
      if (pointer == null) dart.nullFailed(L0, 254, 30, "pointer");
      if (state == null) dart.nullFailed(L0, 254, 53, "state");
      if (member == null) dart.nullFailed(L0, 254, 79, "member");
      if (!dart.equals(state, this[_arenas][$_get](pointer))) dart.assertFailed(null, L0, 255, 12, "state == _arenas[pointer]");
      if (!(state != null)) dart.assertFailed(null, L0, 256, 12, "state != null");
      if (!(state.eagerWinner == null || dart.equals(state.eagerWinner, member))) dart.assertFailed(null, L0, 257, 12, "state.eagerWinner == null || state.eagerWinner == member");
      if (!!dart.test(state.isOpen)) dart.assertFailed(null, L0, 258, 12, "!state.isOpen");
      this[_arenas][$remove](pointer);
    ...
    [_debugLogDiagnostic](pointer, message, state = null) {
      if (pointer == null) dart.nullFailed(L0, 267, 32, "pointer");
      if (message == null) dart.nullFailed(L0, 267, 48, "message");
  ...
  dart.setLibraryUri(arena.GestureArenaManager, L1);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["arena.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAkBA;;;QANK;;;;;EAML;;;;;;;;;;;;;;;;EAgBA;;;;;;;;;;UAiBkC;AACiB,MAA/C,AAAO,wBAAS,iBAAU,gBAAS,WAAW;IAChD;;yCAZyB,QAAa,UAAe;QAA5B;QAAa;QAAe;IAA5B;IAAa;IAAe;;EAAQ;;;;;;;;;;;;;;;;UA2BjC;AAC1B,qBAAO;AACY,MAAnB,AAAQ,mBAAI,MAAM;IACpB;;AAIqB,mBAAS;AAC5B,oBAAI,AAAQ;AACa,QAAvB,AAAO,MAAD,OAAO;;AAMC,QAJd,AAAO,MAAD,OAAO,AAAQ,AAIlB,gCAJ8B;cAAoB;AACnD,cAAW,YAAP,MAAM,EAAI,mBACZ,MAA+B,UAAtB,MAAM;AACjB,gBAAgB,UAAP,MAAM;iDACT;;AAEV,oBAAI,cACF,AAAO,AAAgB,MAAjB,OAAO;AACf,oBAAI,cACF,AAAO,AAAgB,MAAjB,OAAO;AACf,oBAAI,uBACF,AAAO,AAA2B,MAA5B,OAAO;AACf,YAAO,AAAO,OAAD;IACf;;;IAnC+B,eAA8B;IACxD,cAAS;IACT,cAAS;IACT,uBAAkB;IAMH;;EA2BtB;;;;;;;;;;;;;;;;;;;;;;;QAa4B,SAA4B;UAA5B;UAA4B;AAChC,kBAAQ,AAAQ,4BAAY,OAAO,EAAE;AACvD,uBAAO,0BAAoB,OAAO,EAAE;AACpC,cAAO;;AAEQ,MAAjB,AAAM,KAAD,KAAK,MAAM;AAChB,qBAAO,0BAAoB,OAAO,EAAE,AAAiB,sBAAP,MAAM;AACpD,YAAyB,gCAAE,MAAM,OAAO,EAAE,MAAM;IAClD;;UAKe;AACQ,kBAAQ,AAAO,qBAAC,OAAO;AAC5C,UAAI,AAAM,KAAD,IAAI,MACX;AACkB,MAApB,AAAM,KAAD,UAAU;AACf,qBAAO,0BAAoB,OAAO,EAAE,WAAW,KAAK;AAClB,MAAlC,yBAAmB,OAAO,EAAE,KAAK;IACnC;;U