define(['dart_sdk', 'packages/flutter/src/gestures/events.dart'], (function load__packages__flutter__src__gestures__resampler_dart(dart_sdk, packages__flutter__src__gestures__events$46dart) {
  ...
  var L1 = "package:flutter/src/gestures/resampler.dart";
  var L0 = "file:///Users/divyeshbansal/Documents/android/flutter/packages/flutter/lib/src/gestures/resampler.dart";
  ...
  resampler.PointerEventResampler = class PointerEventResampler extends core.Object {
    [_toHoverEvent](event, position, delta, timeStamp) {
      if (event == null) dart.nullFailed(L0, 47, 18, "event");
      if (position == null) dart.nullFailed(L0, 48, 12, "position");
      if (delta == null) dart.nullFailed(L0, 49, 12, "delta");
      if (timeStamp == null) dart.nullFailed(L0, 50, 14, "timeStamp");
    ...
    [_toMoveEvent](event, position, delta, pointerIdentifier, timeStamp) {
      if (event == null) dart.nullFailed(L0, 77, 18, "event");
      if (position == null) dart.nullFailed(L0, 78, 12, "position");
      if (delta == null) dart.nullFailed(L0, 79, 12, "delta");
      if (pointerIdentifier == null) dart.nullFailed(L0, 80, 9, "pointerIdentifier");
      if (timeStamp == null) dart.nullFailed(L0, 81, 14, "timeStamp");
    ...
    [_toMoveOrHoverEvent](event, position, delta, pointerIdentifier, timeStamp, isDown) {
      if (event == null) dart.nullFailed(L0, 110, 18, "event");
      if (position == null) dart.nullFailed(L0, 111, 12, "position");
      if (delta == null) dart.nullFailed(L0, 112, 12, "delta");
      if (pointerIdentifier == null) dart.nullFailed(L0, 113, 9, "pointerIdentifier");
      if (timeStamp == null) dart.nullFailed(L0, 114, 14, "timeStamp");
      if (isDown == null) dart.nullFailed(L0, 115, 10, "isDown");
    ...
    [_positionAt](sampleTime) {
      ...
      if (sampleTime == null) dart.nullFailed(L0, 121, 31, "sampleTime");
    ...
    [_processPointerEvents](sampleTime) {
      let t0, t0$;
      if (sampleTime == null) dart.nullFailed(L0, 142, 39, "sampleTime");
    ...
    [_dequeueAndSampleNonHoverOrMovePointerEventsUntil](sampleTime, nextSampleTime, callback) {
      if (sampleTime == null) dart.nullFailed(L0, 166, 16, "sampleTime");
      if (nextSampleTime == null) dart.nullFailed(L0, 167, 16, "nextSampleTime");
      if (callback == null) dart.nullFailed(L0, 168, 27, "callback");
      ...
      while (dart.test(this[_queuedEvents][$isNotEmpty])) {
        ...
        if (!(!dart.test(wasDown) || this[_pointerIdentifier] == pointerIdentifier)) dart.assertFailed(null, L0, 226, 14, "!wasDown || _pointerIdentifier == pointerIdentifier");
    ...
    [_samplePointerPosition](sampleTime, callback) {
      if (sampleTime == null) dart.nullFailed(L0, 254, 16, "sampleTime");
      if (callback == null) dart.nullFailed(L0, 255, 27, "callback");
      let position = this[_positionAt](sampleTime);
      let next = this[_next];
    ...
    addEvent(event) {
      if (event == null) dart.nullFailed(L0, 270, 30, "event");
      this[_queuedEvents].add(event);
    }
    sample(sampleTime, nextSampleTime, callback) {
      if (sampleTime == null) dart.nullFailed(L0, 286, 14, "sampleTime");
      if (nextSampleTime == null) dart.nullFailed(L0, 287, 14, "nextSampleTime");
      if (callback == null) dart.nullFailed(L0, 288, 25, "callback");
    ...
    stop(callback) {
      if (callback == null) dart.nullFailed(L0, 305, 33, "callback");
      while (dart.test(this[_queuedEvents][$isNotEmpty])) {
  ...
  (resampler.PointerEventResampler.new = function() {
    this[_queuedEvents] = new (ListQueueOfPointerEvent()).new();
    this[_last] = null;
    this[_next] = null;
    this[_position] = ui.Offset.zero;
    this[_isTracked] = false;
  ...
  dart.setLibraryUri(resampler.PointerEventResampler, L1);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["resampler.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;